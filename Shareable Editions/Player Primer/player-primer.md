...
*A pirate campaign in the Shackles, using the Resistance system.*

You are not heroes; the sea does not care for heroes. You are pirates.

This campaign uses a homebrew system built on the foundation of *Heart: The City Beneath*'s Resistance engine, with its nautical elements drawn from *Wildsea*. It is not a traditional toybox RPG the way D&D is. It is a game designed to tell a specific kind of story arc: the story of what piracy costs, and whether you believe that price is worth it.

You will have liberty. You will have light-hearted, spectacular, disreputable fun — the boarding actions, the impossible escapes, the nights in port that become legends. That part is real, and the system is built to let you enjoy it without apology.
...
The Shackles is an archipelago of hundreds of islands stretching along the western coast of Garund, a large tropical continent reminiscent of Africa. It lies touching the south of the Eye of Abendego, an immortal hurricane that has not stopped spinning in over a thousand years. Nobody made it. Nobody can stop it. The northern Shackles are its permanent shadow.

The region exists in permanent opposition to civilised power. To the north, Cheliax is the dominant naval force of the Inner Sea — disciplined, aggressive, convinced of its own righteousness and the power of its devil gods. To the south, colonies support trade routes for far-flung empires in Tian Xia and eastern Garund. The Shackles exists, in large part, to rob both — along with everyone else they can find — and to drink well afterwards.

## The Free Captains & the Pirate Council

The Shackles has no state. What it has instead is the Free Captains: independent pirate lords who rule from their ships and their islands through reputation, violence, and the fragile web of obligation known as the Pirate Code. The most powerful of these captains sit on the Pirate Council, which meets in Port Peril, the largest city in the Shackles. The Council does not govern so much as manage conflict. It sets prizes, arbitrates disputes, and occasionally decides to make someone's life very short.

Port Peril is the heart of the Shackles — a teeming, dangerous, magnificent city built into a natural harbour, where every vice is available and every transaction has an angle. It is where careers are made and ended, where the Pirate Code is law, and where the smell of salt and smoke never fully leaves the air.

## The Eye of Abendego

The Eye is the defining feature of the Shackles. When it arrived a thousand years ago it destroyed the nation of Lirgen, the kingdom of Yamasa, and the empire of Ghol-Gan — and it has not relented since. It is supernaturally powerful; no natural storm sustains itself for a millennium. Scholars of the event believe it is either a manifestation of divine wrath — perhaps the death of a god — or the consequence of a ritual that went catastrophically wrong. Either way, it is not going anywhere.

The Eye shapes Shackles weather, Shackles culture, and Shackles theology. Besmara, the Pirate Queen — goddess of strife, sea monsters, and plunder — is worshipped here more fervently than anywhere else in the world. She does not promise safety. She promises that if you are strong enough, fast enough, and sufficiently disrespectful of consequences, you might deserve what you take.

## The Islands & the Deep

The Shackles' islands range from thriving pirate ports to uninhabitable jungle ecosystems to ruins that predate human civilisation. The cyclops empire of Ghol-Gan built its monuments across the entire archipelago before vanishing. Their ruins dot the landscape above water and below, still full of traps, guardians, and things that have been waiting in the dark for a long time. Older things still lurk in the deepest trenches and beneath certain islands that have never been properly settled, for reasons that become obvious quickly.

The sea itself is alive with magic: currents that seem to make navigational decisions; creatures of impossible size; ghost-lights that lead sailors to beautiful deaths; sea witches who trade in storm-debts and claim the ocean as their territory; liches and dragons hiding deep in the jungle from adventurers seeking glory.

This is not a safe sea. But it is a magnificent one.
...
- **Hunger or Vendetta?** If your target surrendered what they took but walked away free — enough? Yes: Hunger. No, you need to look them in the eye: Vendetta.
- **Hunger or Monument?** Hunger consumes and moves on; Monument keeps and builds. Is the question what is over the horizon, or what you will leave behind?
- **Hunger or Cursed Tides?** Could you stop? A Hunger character could, in principle. A Cursed Tides character is pulled whether they consent or not.
- **Hunger or Legacy?** Begin with nothing and take it, or begin holding something you never earned.
- **Monument or Legacy?** Monument constructs weight from nothing; Legacy inherits weight and must decide what to do with it.
- **Monument or Fellowship?** Which would you sacrifice first — the friendship or the structure? Monument keeps people because they are useful; Fellowship keeps them because they are irreplaceable.
- **Vendetta or Freedom?** If the target died tomorrow: grief at a lost purpose is Vendetta; getting back to work is Freedom. One points at a person, the other at a system.
- **Freedom or Fellowship?** Freedom burns a stranger's cage on principle; Fellowship counts the cost to these specific people first. Both are generous — differently.
- **Freedom or Cursed Tides?** One refuses every claim; the other is already claimed. (In a single character, this contradiction is fuel, not a problem.)
...
*There is always another horizon, and behind it the thing you actually want. You tell yourself this one is the last one. The sea is wide, the take is never enough, and somewhere out there is the prize that will finally fill you up. It won't.*

### CORE ABILITY

**ONE MORE THROW.** You have never once accepted the first no. Once per session, after failing a roll in pursuit of something you want, reroll it. If you fail again, the incoming stress steps up one size.

When you create your character, answer these questions:

- What are you hunting, and what have you already spent on it?
- Choose another player character. You nearly died together going after something. What was it, and who pulled who out?
- Choose another player character. What do they own that you cannot stop noticing?
- Which rival is on the same trail, and how far ahead are you?

### MINOR BEATS

- Take Minor Luck fallout.
- Take Minor Gold fallout.
- Steal something while its owner watches.
- Follow a rumour to a Tier 2 landmark or deeper.
- Sell or sacrifice a D8 or higher resource to keep the trail warm.
- Beat a rival to a prize by hours.
- Shake on a deal you can't honour.
- Refuse pay you badly need.
- Spend your last reserve at the worst moment.
- Acquire a bond who deals in maps, secrets or stolen goods.
- Tell another PC the whole history of what you hunt.
- Walk into obvious danger because the prize might be there.
- Stand somewhere no one on the crew has stood.
- Learn that something you carry is worth more than you knew.
- Promise another PC a share to get them aboard a bad idea.
- Keep a worthless thing you cannot explain keeping.
- Give away something the moment you finally hold it.
- Win a haggle you had no business winning.
- Come back to a place you knew and find it changed beyond recognition.
- Get caught red-handed.

### MAJOR BEATS

- Take Major Luck fallout.
- Claim a prize that significant opposition guarded.
- Sell or sacrifice a D12 resource to learn what waits ahead.
- Reach a Tier 3 landmark that appears on no reliable chart.
- Betray an ally for a bigger share.
- Lose the most valuable thing you own.
- Learn the prize is cursed, guarded or worse than the stories — and keep going.
- Hold something the Aspis Consortium will kill to recover.
...
2. Lockpicks worn smooth with use
3. Chart of a place no official map shows, annotated in three hands
4. Coin from a mint that no longer exists
5. Letter of provenance for an item you don't own yet
6. List of everyone who hunted it before you, with notes on how they ended
7. Treasure map you drew yourself as bait, and have started to believe
...
*Most pirates take. You are making something — out of ships, stories, favours and fear — and every port that knows your name is a course of bricks laid true. One day the work will stand without you. The trick is living long enough to step back and see it.*

### CORE ABILITY

**BRICK BY BRICK.** You strive to live up to the thing you are building. When you gain a minor advance, refresh D6. When you gain a major advance, refresh D8.

When you create your character, answer these questions:

- What are you building, and what do you call it in your honest moments?
- Choose another player character. They hold up part of the structure without knowing it. What part?
- Choose another player character. They knew you when you were nobody. What do you need from them now?
- Which port already tells a story about you, and how wrong is it?

### MINOR BEATS

- Take Minor Reputation fallout.
- Be mistaken for something greater than you are.
- Publicly humiliate a rival, effortlessly.
- Make a speech meant for the retelling.
- Hear your story told by someone who doesn't know you're listening.
- Refuse to retreat — the ground is yours now.
- Show mercy because the story of it is worth more than the kill.
- Have a ship change course at the sight of your flag.
- Donate a D8 or higher resource to a haunt, loudly.
- Take credit for another pirate's work.
- Plant influence in a port you've never held: a favour, a debt, a flag.
- Dictate terms to someone holding the upper hand.
- Acquire a bond who owes you something they can't repay.
- Describe the finished work to another PC.
- Choose a person over the structure, and let a brick fall.
- Find your name somewhere you never put it.
- Pick a side in a port dispute because the outcome serves the work.
- Hear yourself used as the measure of someone else.
- Pay to make a story go away.
- Commission a song, a broadsheet or a rumour about yourself.

### MAJOR BEATS

- Take Major Reputation fallout.
- Enter an enemy power's records: a Chelish mandate, an Aspis dossier.
- Win formal recognition from the Free Captains or the Pirate Council.
- Take and hold a berth, a route or an allegiance against opposition.
- Upgrade a haunt to D10 or higher and put your name on it.
- Make another PC load-bearing, and tell them what that means.
- Watch a piece of the structure fall in public.
- Learn that someone you trusted has been hollowing the walls.
...
2. Custom seal and a stick of black wax
3. Ship's manifest naming you owner of a vessel you don't yet possess
4. Bundle of captains' debts tied in red cord
5. Broadsheet about you, wrong in three ways you've never corrected
6. Ledger of your deeds, with dates and witnesses
7. Portrait of you, commissioned at great expense, that doesn't quite look like you
...
*They took something from you that cannot be replaced, and they are still breathing. Every prize you take is practice; every port is a place they might be. You will look them in the eye before the end. What happens after that, you have never once let yourself imagine.*

### CORE ABILITY

**NOT WHILE THEY BREATHE.** You do not get to fall — not before they do. Once per session, activate this ability to avoid suffering negative effects from Blood or Reputation fallout for the remainder of the situation.

When you create your character, answer these questions:

- Who are they, what did they take, and how long ago?
- Choose another player character. They stopped you once, an inch from revenge or ruin. Which was it?
- Choose another player character. They know the whole story. Why them?
- What do you carry or wear that your target would recognise on sight?

### MINOR BEATS

- Take Minor Blood fallout.
- Find someone who knows your target personally.
- Cost your target something: property, standing, a good lieutenant.
- Refuse an offered settlement.
- Learn something that makes your target more human.
- Put another PC in danger for the vendetta's sake.
- Meet someone else they hurt.
- Lie to an ally about where you're leading them.
- Acquire a bond who feeds you intelligence.
- Leave a message your target cannot mistake.
- Chase a lead into waters deeper than the crew agreed to sail.
- Tell another PC, in full, what was taken.
- Let hatred make the decision.
- Hear that your target knows you're coming.
- Serve someone else's grievance to feed your own.
- Spend a D8 or higher resource on a lead that dies.
- Show a mercy your target never would.
- Rehearse what you'll say when you find them.
- Learn your target has grown stronger since you started.

### MAJOR BEATS

- Take Major Blood fallout.
- Destroy a major asset of your target: flagship, stronghold, heir.
- Fall into your target's hands.
- Learn something that genuinely complicates the hate.
- Lasting harm lands on another PC or a bond because of your hunt.
- Turn down a clean way to end it without facing them.
- Find out someone hunts you the way you hunt them.
- Your target strikes first, and the crew bleeds for it.
...
2. Loaded pistol kept for one purpose; it has a name you tell no one
3. Their ship's name carved into driftwood
4. List of their allies and ports, kept current in your own hand
5. A letter to them you never sent, explaining everything
6. Court documents proving the wrong, that no court will hear
7. Something of theirs — taken, not given
...
*Someone owned you once — by law, by debt, by force — and you remember exactly what it weighed. Now you are salt and open water, and every cage you meet is yours to break. You call it principle. Some nights it feels more like the chain, still pulling.*

### CORE ABILITY

**NEVER AGAIN.** You carried the weight once. Never again. Once per session, allocate stress you would mark to the nearest friendly target — PC or NPC — instead of marking it yourself.

When you create your character, answer these questions:

- Who held the leash, and what do they still hold — papers, family, a price on you?
- How did you get free, and who didn't make it out with you?
- Choose another player character. One of you freed the other. Which way around, and what's owed?
- Choose another player character. They've watched you risk the whole crew for a stranger in chains. What did they say?

### MINOR BEATS

- Take Minor Blood fallout.
- Free a prisoner, thrall or pressed sailor.
- Refuse a direct order from someone you respect.
- Burn a contract, writ or bill of sale.
- Be caught, bound or held — briefly.
- Meet someone who loves their cage.
- Tell another PC what your captivity was like.
- Acquire a bond you freed, or who freed you.
- Walk away from shelter because of its conditions.
- Stand with strangers you owe nothing.
- Turn down good coin to stay your own master.
- Say what you escaped, in front of those who profit by it.
- Help another PC refuse what they'd already accepted.
- Light a mutiny, a strike or a small rebellion aboard any vessel.
- Take on a debt to break someone else's.
- Step between a cruelty you know and its target.
- Destroy a slaver's ledger worth D8 or more rather than sell it.
- Find the leash hidden inside something you chose freely.
- Hide a runaway through a port inspection.

### MAJOR BEATS

- Take Major Blood fallout.
- Take a vessel and hand it to its own crew.
- Burn a slaving operation or press-gang network out of a port.
- Be recaptured — long enough to cost something real — and break out.
- Refuse power because of what you'd have to hold to keep it.
- Free someone who does something unforgivable with it.
- Stand before the one who owned you.
...
1. Half a broken manacle, worn on a cord
2. Freedom papers, expertly forged
3. Their brand, reworked by your own hand into something else
4. Songbook from captivity, in handwriting that isn't yours
5. List of the names still inside
6. A key from the one who held you; it fits nothing you've found
7. The bill for your own purchase, paid in full — you got yourself at a discount
...
*When you sleep, you dream of deep water, and the dreams are getting accurate. Something beneath the waves has marked you for its own — Besmara, or a thing older than her flag. You sail because it calls you, and because staying ashore feels like drowning slowly.*

### CORE ABILITY

**SALT IN THE VEINS.** The sea keeps what it has tasted. +1 Tide protection. Once per situation, when you would mark stress to any other resistance, you may mark it to Tide instead.

When you create your character, answer these questions:

- When did the sea first speak to you, and what did it cost to listen?
- How has the call marked your body?
- Choose another player character. They watched you obey the water once. What did they see?
- Choose another player character. The sea showed you something about them. Why haven't you told them?

### MINOR BEATS

- Take Minor Tide fallout.
- Heed a warning nothing natural could have given, and be right.
- Eat or drink something of the deep.
- Let something in that a port had kept out.
- Unsettle an NPC with the way you speak about water.
- Perform a rite at a place of power, Tier 2 or deeper.
- Speak with something below the surface.
- Name the thing that calls you, and use only that name from now on.
- Wake somewhere you don't remember sailing.
- Spare a thing of the deep you could have killed.
- Meet something from your dreams while awake.
- Sink, float or lash a shrine to the water.
- Call a course on faith alone, and be right.
- Acquire a bond sworn to Besmara or the deep.
- Obey the tide against your own interest.
- Gain a mark that changes with the moon.
- Find the wakes of others who were called, and how they ended.
- Hide someone else the sea has touched.
- Stay ashore through the call's worst night, for someone else's sake.
- Refuse the call once, and feel what it takes in exchange.

### MAJOR BEATS

- Take Major Tide fallout.
- Perform a rite in a drowned ruin, Tier 3 or deeper, and receive something.
- Give the tide something you love.
- Show an outsider what calls you; watch them break, believe or run.
- A bond suffers fallout because of what follows you.
- Be recognised by something of the deep.
- Follow the call into uncharted waters (this adds D12 to the journey's resistance).
- Be claimed by Besmara's church, or the cults of the Eye, as one of theirs.
...
2. Water-ruined journal of visions; the legible pages are worse
3. Warm timber from a ship lost with all hands
4. A polite note declining your last offering — you haven't told anyone the sea writes
5. Tattoo of a creature you have met only in dreams
6. A page in your own hand, in no script you know
7. Rope that cannot be cut, in a knot you don't remember tying
...
*Your name went to sea before you did. Somebody of your blood did something these islands still remember, and every port has already decided who you are. The legacy is a door, a debt and a loaded gun. The one thing it has never been is yours.*

### CORE ABILITY

**IN THEIR FOOTSTEPS.** You have watched this done — in stories, in dreams, in blood. Gain one skill your ancestor was known for. Once per session, before you roll dice to resolve an action, instead state that your result is a 6. You succeed but take stress.

When you create your character, answer these questions:

- Who came before you, and what did they do that the sea still remembers?
- What do strangers expect of you on hearing your name?
- Choose another player character. Your families' stories are tangled — debt, rescue or crime. Which, and who knows?
- Choose another player character. They treat you differently since learning the name. How?

### MINOR BEATS

- Take Minor Reputation fallout.
- Be recognised for the name before the face.
- Hear something about your ancestor you'd rather not know.
- Catch yourself making their famous decision.
- Refuse a piece of the inheritance.
- Take up a piece of it you once refused.
- Make amends to someone your blood wronged.
- Be turned away for something done before your birth.
- Recover a record, a chart or a D8 or higher resource of your line.
- Learn the famous deed was a lie.
- Gain a follower because of who you come from.
- Do what your line would never do, and say so aloud.
- Meet the heirs or creditors of your family's victims.
- Claim passage, berth or credit on the name alone.
- Tell another PC how your ancestor ended.
- Keep a family custom that costs you.
- Find a stranger wearing your family's name.
- Quiet a room by saying who you are.
- Acquire a bond who served your line, and expects.
- Sail a route your family charted, and pay its toll.

### MAJOR BEATS

- Take Major Reputation fallout.
- Assume a role or burden the line is known for.
- Face the living consequence of the famous deed.
- Be disowned or denounced by those who claimed your blood.
- Unearth the line's buried truth: a crime, a bargain, an heir.
- Make the choice your ancestor couldn't.
- End a piece of the legacy forever: the debt, the feud, the flag.
- Another PC suffers fallout from a feud your blood began.
...
2. Their portrait, with your face in it
3. The log of their last voyage, ending mid-sentence
4. An ancestral debt, still legally valid; the collectors persist
5. Their undelivered letter, memorised
6. A worthless object they treasured, given to you without explanation
7. Their weapon, repaired into technically a different weapon — except it isn't
...
*Other pirates sail for gold or glory. You sail for the faces around the watch-lantern — these people, this ship, this unrepeatable luck. They are the only wealth you have ever counted. The sea knows exactly how to hurt you, and one day it will.*

### CORE ABILITY

**THE BODY BETWEEN.** What hits them hits you first, if you're fast enough. Once per session, when another PC or named crewmember within reach marks stress, you may mark it instead of them.

When you create your character, answer these questions:

- Choose another player character. You would die for them without a thought. What made it true — and do they know?
- Choose another player character. You failed them once, badly. What changed in you?
- Who did you lose before this crew, and what of theirs do you still carry?
- The ports say this crew holds together because of you. What did people see that started that story?

### MINOR BEATS

- Take Minor Luck fallout.
- Put your body between a crewmate and harm.
- Learn a secret a crewmate has told no one.
- Share true rest with the crew: a meal, a calm watch, a shore night.
- Make the call the crew hates, and carry the friction.
- Quietly cover another PC's mistake.
- Acquire a bond who becomes family, not contact.
- Pass up a windfall that would mean leaving someone.
- Tell a crewmate the truth they didn't want.
- Cheer another PC's victory louder than your own.
- Grieve for one of the crew's dead.
- Take blame that wasn't yours.
- Be seen at your worst by the people you hold up.
- Fight with a crewmate over values, not tactics.
- Keep everyone moving while everything burns.
- Fail someone who needed you, and face them.
- Suffer fallout from stress you took for someone else.
- Vouch for a stranger with your own standing.
- Pay a crew debt out of your own share, silently.
- Be caught keeping count of everything that could take them.

### MAJOR BEATS

- Take Major Luck fallout.
- Save a crewmate when the sensible call was letting go.
- Lose one of the crew for good.
- Learn something that tests your loyalty to its limit.
- Hold the crew together through shipwreck, mutiny or massacre.
- Tear the crew apart, and mend what you tore.
- Give up safety, fortune or freedom so the crew keeps theirs.
...
1. Small things they gave you, kept secretly together
2. A letter never sent, added to for months
3. Every name you've ever sailed with, one word beside each
4. A carved figure of a crewmate, never shown
5. A dead crew's tradition, kept alone
6. A scar a friend gave you and doesn't know about
7. An old crew's song, sung badly, alone
...
*The ship, the sea, the prize, the port, the Code. Whatever else drives you, this is the life you all chose, and it keeps its own ledger. Every crew gets a story. The sea decides how long it runs; you decide what it is about.*

Every character holds Piracy alongside their personal calling. At the end of each session, choose two active beats from either pool.

When you create your crew, answer these questions together:

- What is your ship, and what did it cost to get her?
- What was the crew's first prize together, and what went wrong?
- Which port counts as home, and who there wishes you wouldn't?
- What enemy already knows your flag?
...
- Take Minor Luck fallout.
- Take Minor Reputation fallout.
- Survive a storm, a rogue wave or the Eye's weather.
- Make the navigational call the crew must live with.
- Outrun a superior sail — or turn and face it.
- Board a prize and deal with what's actually aboard.
- Complete a journey through Tier 2 waters or deeper.
- Stand the night watch alone, and come in changed.
- Acquire a bond in a port: fence, keeper, harbourmaster.
- Be recognised for something you did — or didn't.
- Find trouble ashore that has nothing to do with your obsessions.
- Pass a port inspection with something to hide.
- Drink a port dry and stay welcome.
- Invoke the Code, win or lose.
- Share a dock with a rival crew without incident — barely.
- Be asked to do something the Code allows and your stomach doesn't.
- Watch the Free Captains' politics up close.
- Take a prize and learn what it's actually worth.
- Divide shares, and feel the division bite.
- Lose a prize to weather, pursuit or a fair decision.
- Sell loot to someone who knows where it came from.

### MAJOR BEATS

- Take Major Blood fallout, and keep sailing.
- Take Major Reputation fallout, as the Shackles reassesses you.
- Survive what should have killed you, with the crew watching.
- Draw the formal attention of the Chelish Navy, the Aspis Consortium or a rival Free Captain.
- Lose a ship.
- Make an enemy with the standing to matter.
- Tip the politics of the Shackles, even slightly.
- Gain or lose enough to change the ship's quality or a haunt's dice.
...
2. A share-token from your first prize, drilled and worn
3. Your copy of the articles, signed by every hand
4. Dice carved from the mast of a ship that didn't make it
5. A storm-glass that has never once been wrong
6. One of the three keys to the spirit locker
7. A pistol ball they dug out of you, kept as change
...
- EQUIPMENT: Scavenged knife Brave D6
    - Pick one:
        - Wreck-iron machete Brave D8, Brutal, Tiring
        - Poultices, fish-gut sutures and salvage-kit remedies Tend Blood D6
        - Harpoon and salvaged line Hunt D8, Ranged, Tiring

### CORE ABILITIES

#### ISLANDSBLOOD
_The wild places of the Shackles recognise you as one of their own; the further you get from civilisation, the harder you are to kill._ Your minimum protection value for all resistances is equal to the tier of your current location. This value doesn't add to other sources of protection, but your base protection can't be lower than your current tier unless you specifically lose access to it due to fallout.

> Tiers are defined in **Location Tiers** (System Documents): regional danger from 0 (lawful waters) to 4 (the drowned places), with each step inland from the shore increasing the tier by one.

#### THE RED FEAST
_Your changed guts pluck memories from the meat._ When you eat a resource, you gain any domains associated with that resource until the end of the situation. If you already have access to the domain, gain an appropriate knack. There's no limit to what you can eat, but tough or noxious materials might require an Endure+Wilderness check to avoid causing yourself harm. Consuming resources requires your attention and leaves you exposed, so doing it successfully in stressful situations (such as combat) could require a Vanish roll.

### MINOR ABILITIES

#### CRAB AND ROOT
_You learned medicine from an island pharmacopoeia that no physician has catalogued — and you can put a crewmate back together with it as readily as yourself._ Gain the Tend skill. You can treat Blood stress and fallout — your own or an ally's — without equipment or supplies, using whatever grows, crawls or seeps nearby. When you treat an ally this way, your Tend dice increases by one step.

#### DESPERATE MEASURES
_You've eaten people. The longboat drifted for six weeks; you came ashore alone._ Gain the Deepwater domain. You can consume the flesh of something or someone that you have recently killed and gain a skill associated with them for the remainder of the situation.

#### FERAL TRACKING
_Your survival depended on knowing exactly what else shared the island with you._ Gain the Hunt skill. Roll with mastery when you follow a trail, and you always know whether a trail was made deliberately or carelessly — which is usually the more important piece of information.

#### GUT INSTINCT
Gain access to one of the following skills: Brave, Deceive, Endure, Hunt, Navigate, Plunder, Reckon, Tend, Vanish. You can take this advance more than once.

#### INHUMAN
Gain +1 protection in the Blood, Tide, Reputation or Gold resistance. You can take this advance more than once.

#### INTERIOR
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Arcane, Ruins, Wilderness. You can take this advance more than once.

#### RUIN-WALKER
_The old stonework feels inhabited to you, and whatever inhabits it has decided you can stay._ Gain the Ruins domain. Once per session, when you shelter and rest in a ruin, refresh D4.

#### SALT-STILL
_Things that hunt by motion taught you the value of perfect quiet._ Gain the Vanish skill. While you remain still in natural terrain — jungle, reef, shoreline, ruin — Vanish rolls are never considered Risky or Dangerous.

#### SCAVENGED ARSENAL
_Your hands know what to make before your mind has finished the question._ Gain the Plunder skill. Improvised weapons you build or seize inflict D6 stress rather than D4. The results are ugly. They are exactly sufficient.

#### SPEAKING TO STRAYS
_Whatever the island put in you, the animals can smell it too._ Gain the Arcane domain. Creatures of the wild Shackles treat you as adjacent kin — neither prey nor pack, simply present. Once per session, you can call on the local wildlife to create a distraction, carry a small object or throw an area into bestial chaos.

#### THE CHANGED PALATE
_Food is fuel for the thing the island lit inside you._ Gain the Brave skill. When you use THE RED FEAST ability, you may choose to have your attacks gain the Brutal tag for a number of actions equal to the amount rolled on the resource dice instead of gaining a domain.

#### THE ISLAND'S CLAIM
_Something that may be the island and may be something in the island intends to keep you functional._ Gain +2 Tide protection.

#### WHAT THE ISLAND HARDENED
_Your body has adapted to conditions that should have killed it several times over._ Gain +2 Blood protection.
...
- EQUIPMENT: Pick one:
    - Excavator's pick Plunder D8, Brutal, Tiring
    - Lantern-staff of salvaged Azlanti glass Brave D6; sheds clean light that needs no fuel
    - Field conservation kit and a pocket pistol Tend Gold D6; Hunt D6, Ranged, Reload

### CORE ABILITIES

#### THE ARCHIVE
_You carry an annotated spellbook that is also a historical record; to you these are the same document, and objects speak to you as readily as pages._ At character creation, establish one dead language you can read and one drowned civilisation that is your particular study — these are always available as knowledge, without rolls. When you first encounter a ruin, wreck or significant relic, the GM tells you one true thing about its history and one true thing about its dangers. You also handle and conserve the past directly: gain the Tend skill, and once per session, when you handle a significant object with a minute's attention, you learn who made it, approximately when, what it was used for, and the most significant event it witnessed.

#### WHERE THE PAST LINGERS
_The old places remember their own workings, and they recognise a practitioner._ When you are in a ruin, a wreck, or any place abandoned since before living memory, roll with mastery when you attempt to cast a spell.

### MINOR ABILITIES

#### ACADEMIC NETWORK
_You correspond with scholars, archivists and obsessives across the Inner Sea._ Gain the Colonial domain. Once per session, when you make port, a letter is waiting for you containing one piece of relevant historical intelligence. Your correspondents live in the colonial world; keeping them requires navigating its politics carefully.

#### COMPARATIVE STUDIES
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Arcane, Ruins, Faith, Colonial. You can take this advance more than once.

#### THE DIG MAPPED
_One eye on the chart of what drowned, one on what's worth pulling out of it._ Gain the Navigate skill. Once per session, when seeking a wreck, ruin or drowned settlement, ask the GM where to start looking, and they will tell you. When you reach a site, ask what the single most valuable thing you could extract is — and what extracting it will cost — and they will tell you.

#### FIELD RESEARCH
Gain access to one of the following skills: Carouse, Deceive, Endure, Hunt, Navigate, Plunder, Reckon, Tend, Vanish. You can take this advance more than once.

#### GRAVE GOODS
_The dead were buried with their power. They have stopped needing it._ Gain the Shallows domain. Before you cast a spell from this class, you can opt to destroy a resource with the Ruins domain. Roll the resource's dice; the amount rolled is added to your Protection value against any stress incurred as a result of casting the spell.

#### THE EXCAVATOR'S ANSWER
_You have spent a career learning where old stone wants to break, where a sealed tomb's hinge is weakest, what a millennium does to bone. The same eye reads the things that guard those places._ Gain the Plunder skill. Your excavator's pick (and like tools) is a weapon in your hands. Against stone, bone, construct or undead — the things that haunt ruins and wrecks — your attacks gain the Piercing tag; you know exactly where the centuries left them weak.

#### PRESERVATION
Gain +1 Protection in the Blood, Tide, Reputation or Gold resistance. You can take this advance more than once.

#### PROVENANCE
_Every artefact is worth what its story says it is worth. You write excellent stories._ Gain the Deceive skill. Roll with mastery when you authenticate — or fabricate — the provenance of any artefact, relic or historical document.

#### THE OLD WAY
_The god may be dead, but the working remembers._ Gain the Faith domain. Once per session, perform a rite from a dead faith: a small blessing, a temporary protection against supernatural harm, or words that a specific kind of spirit will stop and answer.

#### TONGUE OF THE DEAD
_Ancient, dead and deliberately obscured scripts are your speciality._ Gain the Arcane domain. You can read any written language you have encountered before, and you can attempt any script you have never seen with a Reckon+Arcane roll.

#### WARDED SCHOLAR
_Your body carries inscriptions copied faithfully from tombs that were never robbed._ Gain +2 Tide protection.

#### WHAT KNOWLEDGE FETCHES
_There is always someone who will pay for what you know, and usually before the situation becomes critical._ Gain +2 Gold protection.
...
- EQUIPMENT: Cutlass Brave D6
    - Pick one:
        - Boarding axe Plunder D8, Brutal, Tiring
        - Brace of pistols Hunt D6, Ranged, Reload
        - Sea-chest surgeon's kit and belaying pin Tend Blood D6; Brave D6

### CORE ABILITIES

#### THE TESTED BODY
_You have been broken before. You know what it costs to keep moving._ Once per situation, when you suffer Minor Blood fallout, you may ignore its effects until the end of the situation. When the situation ends, the fallout arrives in full and you mark D4 Blood stress — the body keeps honest books.

#### VIOLENCE AS ARGUMENT
_Your reputation for controlled, purposeful violence precedes you._ When you make a credible threat of violence to someone who knows your history, roll with mastery to compel, cow or halt them. Once per session, when you publicly demonstrate your capability — breaking something, surviving something, ending a fight with impossible efficiency — clear D4 Reputation stress.

### MINOR ABILITIES

#### BOARDING MASTER
_People don't need your orders. They just move when you move._ Gain the Command skill. When you lead a boarding action, you and all allies following your lead gain +1 Blood protection until they next act.

#### EARNED FEAR
_The hesitation your name creates is real, and it buys the time that keeps a legend alive._ Gain +2 Reputation protection.

#### FIGHTING TRIM
Gain access to one of the following skills: Brave, Carouse, Command, Endure, Hunt, Navigate, Plunder, Tend, Vanish. You can take this advance more than once.

#### HARBOUR LEGEND
_Every dockside from Bloodcove to Drenchport holds someone who saw you fight._ Gain the Port domain. In any port where you have fought before, at least one person will stand you a drink, back you in a brawl, and tell you what the harbour is saying about you.

#### IRON STOMACH
_The sea has poisoned you so many ways it has run out of new ones._ Gain the Endure skill. When you mark stress from disease or poison, mark it one dice size smaller.

#### THE KILLING GROUND
_You move through the aftermath with deliberate efficiency._ Gain the Plunder skill. Once per session, when you loot a battlefield, a boarded ship or a defeated enemy, ask the GM what the most valuable thing present is and they will tell you.

#### NOTCHES ON THE HILT
_Your weapons are cross-hatched with kill-marks; a testament to what the sea has made of you._ Gain the Hunt skill. Whenever you kill a person or creature, remove 1 stress from any resistance.

#### OLD SALT'S STITCHES
_You have closed your own wounds in a rolling sea by lamplight — and worse in your crew. It is not gentle work. It holds._ Gain the Tend skill. You can treat your own Blood stress and fallout without assistance and without the Risky penalty. Once per situation, you also patch a nearby ally in the middle of things: remove D6 Blood stress from them, or, with your sea-chest surgeon's kit to hand, downgrade one Minor Blood fallout instead. The crew has learned not to look.

#### RAIDER'S COVES
_Every coast keeps a place to careen, hide or wait with the guns run out._ Gain the Shallows domain. Once per session, within a day's sail of a coastline, ask the GM for an anchorage suited to hiding, repair or ambush and they will tell you — and whether anyone else knows it.

#### SCAR TISSUE
_The sea has tried to kill you in very specific ways. It will have to try differently next time._ Gain +2 Blood protection.

#### SEA LEGS
Gain +1 Protection in the Blood, Tide, Reputation or Luck resistance. You can take this advance more than once.

#### WHAT'S MINE
_The Code is clear, and so are you._ Gain the Outlaw domain. When someone tries to take what's yours — your ship, your share, your crew — your attacks gain the Brutal tag when you attempt to stop them.

#### WHERE THE WIND TAKES YOU
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Port, Colonial, Wilderness. You can take this advance more than once.
...
- EQUIPMENT: A knife in your boot Brave D6
    - Pick one:
        - Matched throwing knives Hunt D6, Ranged, Brutal
        - Collapsible grapnel and fifty feet of silk line Navigate D6
        - Pouch of smoke vials Vanish D6

### CORE ABILITIES

#### ALWAYS A WAY OUT
_There are three exits from this room. You checked._ At the start of each situation, declare one exit — a route, a gap, a prepared escape — that exists regardless of circumstances. Once per situation, you may use it to remove yourself (and one ally who stays close) from immediate danger without a roll; when you do, mark D4 stress to Luck — the universe keeps count. This cannot be used if you are bound, submerged or sealed inside something. It can be used if you are outnumbered, surrounded, on fire, or in a conversation that has gone badly.

#### MOMENTUM
_As long as you keep moving, the world can't get a grip on you._ When you succeed on any action that involves moving — running, climbing, swinging, diving, vaulting — you may immediately move again as part of the same action without a second roll. On a failure, you still move, but something goes wrong along the way. You cannot benefit from this ability while standing still.

### MINOR ABILITIES

#### ACROBAT
_Your body does things most bodies do not._ Gain the Brave skill. Movement through difficult terrain — rigging, rooftops, crowded docks, collapsing structures — is never considered Risky or Dangerous for you solely because of the physical challenge.

#### COASTWISE
_A cove not on any chart; a reef passage that looks like a dead end from the surface._ Gain the Shallows domain. Roll with mastery to pass through a coastline that is actively searching for you; doing something memorable forfeits the advantage.

#### KNIFE ACT
_You were paid to do this without hitting the person standing next to the target._ Gain the Hunt skill. Your thrown blades function as (Hunt D6, Ranged, Brutal) and you carry enough that running out is never the first problem. When you throw at a specific, named point — a held weapon, a rope, a lock, a candle — roll with mastery.

#### MISDIRECTION
_People look where you point._ Gain the Deceive skill. Once per situation, direct everyone present to look at something other than what you are actually doing — a shout, a thrown object, a staged stumble. Roll your next action, taken immediately and quietly, with mastery; it cannot be an attack.

#### NINE LIVES
_You do not go down easily, and when you do, it is always somewhere inconvenient for whoever put you there._ Gain +2 Blood protection.

#### THE PRESTIGE
Gain access to one of the following skills: Brave, Carouse, Command, Deceive, Hunt, Navigate, Plunder, Reckon, Vanish. You can take this advance more than once.

#### PICKPOCKET
_A moment of proximity and a moment of distraction._ Gain the Reckon skill. You can lift anything a person is carrying without them noticing; the GM will tell you what they're carrying before you reach for it. If a target is actively watching for theft, roll Vanish — on a partial success you take it, but they notice something was wrong.

#### RIGGING RAT
_The tops are yours._ Gain the Deepwater domain. You always have the high ground aboard a vessel if you want it, and your first attack after dropping from height gains the Brutal tag.

#### THE ROVING LIFE
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Port, Colonial, Ruins. You can take this advance more than once.

#### SMOKE AND SHADOW
_Drinking, laughing, belonging._ Gain the Carouse skill. You can disappear into any crowd by becoming the most natural person in it; roll with mastery to lose a pursuer through a crowd.

#### STREET-LEARNED
_You watched the colonial system from underneath and learned to abuse it from inside._ Gain the Colonial domain. You know which paperwork holds up, which officials are worth bribing and which laws have convenient loopholes; you can move through colonial-held territory without looking like what you are.

#### TIGHTROPE LUCK
Gain +1 Protection in the Blood, Tide, Luck or Gold resistance. You can take this advance more than once.

#### THE UNIVERSE KEEPS MISSING
_Bad luck has to catch you first._ Gain +2 Luck protection.
...
- EQUIPMENT: Pick one:
    - Heirloom duelling sword Hunt D8, Piercing, Expensive
    - Matched pistol and parrying blade Hunt D6, Ranged, Reload; Hunt D6, Brutal
    - Campaign kit: field manuals, whetstone and surgeon's roll Tend Blood D6; arming sword Brave D6

### CORE ABILITIES

#### THE FORM
_You trained in a specific, named fighting tradition — establish it at character creation: its place of origin, its philosophy, its lineage of masters._ When you fight a single opponent in conditions that allow the form to operate — space to move, clear engagement lines, some degree of mutual awareness — the stress dice of your attacks increases by one step. When the Shackles refuses to hold still and be a proper fight, you still know more than they do. You are just doing it the hard way.

#### READ THE FIGHTER
_Training creates patterns, and patterns can be known._ Once per session, after watching someone fight, spar or simply move, the GM tells you their strongest technique and their worst vulnerability. Roll with mastery when you act on what you learned. This works on anyone with something resembling technique; those who fight with pure chaos or supernatural force cannot be read this way.

### MINOR ABILITIES

#### ACADEMY TRAINING
Gain access to one of the following skills: Brave, Carouse, Command, Deceive, Endure, Hunt, Reckon, Tend, Vanish. You can take this advance more than once.

#### CAMPAIGN HARDENED
Gain +1 Protection in the Blood, Reputation, Luck or Gold resistance. You can take this advance more than once.

#### CHALLENGE
_The terms you set are binding._ Gain the Command skill. Once per session, issue a formal challenge that carries legal and social weight in any port with colonial influence — which in the Inner Sea means most of them. The target must respond publicly: accept, refuse and lose standing, or attempt to avoid, which you may pursue without social consequence.

#### THE CODE DUELLO
_Two legal systems govern formal violence in these waters. You know how to invoke both, and how to make them conflict when that is useful._ Gain the Outlaw domain. The Pirate Code's provisions for challenges, duels and trials by combat are as familiar to you as your own school's forms, and most Free Captains will pause and hear you out when you cite them.

#### COLONIAL PASSAGE
_Your bearing, your vocabulary and a name you can support open doors that are closed to pirates._ Gain the Deceive skill. Roll with mastery when you pass as a naval officer, merchant official or member of a noble house.

#### FORM PERFECT
_Combat in the Shackles is audience as much as violence._ Gain the Port domain. When fighting where others can observe you, roll with mastery on your first action — and afterwards, you know exactly how the story will be told in the taverns tomorrow, and to whom.

#### LETTERS OF CREDIT
_Your name is still good with colonial banking houses that have not yet heard, or do not care, what you have become._ Gain +2 Gold protection.

#### MEASURED THREAT
_The colonial world produced a specific kind of person who can make death sound like a scheduling matter._ Gain the Endure skill. When you indicate with cold technical precision that a situation is about to become violent, NPCs of reasonable intelligence believe it without demonstration.

#### NAVAL LAW
_Prize law, letters of marque, and the provisions that distinguish piracy from privateering._ Gain the Reckon skill. Once per session, ask the GM what legal mechanism — a technicality, a jurisdictional gap, a formal right — applies to the current situation that no one else present knows exists. The GM answers honestly, and the mechanism is real.

#### SCHOOLED DEFENCE
_Your tradition spent centuries working out how to survive being wrong once._ Gain +2 Blood protection.

#### SECOND STEEL
_A tradition that does not account for the loss of the primary weapon is not a complete tradition. Yours is complete._ Gain the Brave skill. You fight equally well with either hand, and when disarmed, you produce a second weapon without a roll — it was always there.

#### SWORN ORDER
_The vows are older than the exile._ Gain the Faith domain. Once per session, when you keep your vows at real cost to yourself — protecting someone inconvenient, honouring terms no one would have enforced — clear D4 Reputation stress. Word of it travels.

#### A WIDER EDUCATION
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Colonial, Port, Faith. You can take this advance more than once.
...
- EQUIPMENT: Pick one:
    - Two old-fashioned pistols Hunt D8, Ranged, Loud, One-Shot
    - Witch-etched duelling pistol Hunt D6, Ranged, Brutal, Dangerous
    - Overstuffed coat of tools and charms and a boot-pistol Tend Blood D6; Hunt D6, Ranged, Reload

### CORE ABILITIES

#### POWDER BOND
_The tingle in your fingers tells you where the fire is._ You can detonate any unattended powder charge or loaded firearm within thirty paces by will alone; powder carried or worn by a person is shielded by its bearer's luck — detonating it is an attack, rolled Hunt+Arcane. You always know the location of gunpowder, loaded weapons and other ignition sources nearby — including magical equivalents: fire-workings, alchemical bombs, anything waiting to burn.

#### BURN THE BODY
_The magic is eating through you, and you have learned to lean into the heat._ When your Blood stress is 4 or higher, roll with mastery when you attempt to cast a spell.

### MINOR ABILITIES

#### BEEN EVERYWHERE
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Arcane, Colonial, Faith, Ruins. You can take this advance more than once.

#### BY ANY MEANS
Gain access to one of the following skills: Brave, Carouse, Deceive, Hunt, Navigate, Plunder, Reckon, Tend, Vanish. You can take this advance more than once.

#### CALLED SHOT
_Wind, distance, angle, the target's movement — the answer arrives complete._ Gain the Reckon skill. When you name a specific point before firing — a hand, a rope, a lock, a lantern — and succeed, the shot hits exactly that point. This is not magic. It is calculation.

#### DEEP POCKETS
_Your coat is overstuffed with the trade's leavings: doctored powder, fuse-cord, charms against damp, and three things you could sell if it came to that._ Gain +2 Gold protection.

#### FALSE THUNDER
_Besmara's thunder and yours are indistinguishable from the deck of a sinking ship._ Gain the Faith domain. When you use SLOW MATCH, you may also consume resources with the Faith domain.

#### GHOL-GAN FIRE
_You have recovered pre-human incendiary formulae from drowned stonework, and improved them._ Gain the Ruins domain. Choose one alchemical round you know how to brew: incendiary (the target catches fire, marking D4 stress each round until extinguished), concussive (the target's next action is Risky) or smoking (the area gains the Obscuring quality). You can carry three at a time; restocking takes an hour of downtime.

#### NAVY GUNNER
_You learned the great guns on a colonial deck before the magic found you._ Gain the Colonial domain. You can crew, aim and command cannon of any navy's pattern, and you know their drill, their signals and the layout of their magazines from the inside.

#### QUICK DRAW
_They didn't catch you without a weapon. They simply didn't find the one you had._ Gain the Brave skill. Regardless of searches, disarmament or social convention, you always have something small, loaded and sufficient.

#### SIPHON OF FORTUNE
_There are tables in Port Peril where you can stake more than coin; your wager of choice is good luck._ Gain +2 Luck protection.

#### SLOW MATCH
_Powder burned with intention is a prayer the universe has to answer._ Gain the Tend skill. Before you cast a spell from this class, you can opt to destroy a resource with the Arcane domain. Roll the resource's dice; the amount rolled is added to your Protection value against any stress incurred as a result of casting the spell.

#### SMOKE AND MIRRORS
_The smoke goes where you tell it._ Gain the Vanish skill. When you fire, you can direct the smoke to obscure vision, and you may roll Vanish with mastery to reposition unseen behind it.

#### THE POWDER TRADE
_Your appetite put you deep into the networks that move powder through the Shackles._ Gain the Outlaw domain. Once per session, ask the GM where powder can be sourced in this port, regardless of legality, and they will tell you; the smugglers who move it consider you a customer worth keeping alive.
...
- EQUIPMENT: Bone saw Brave D6
    - Pick one:
        - Carpenter's maul Brave D8, Brutal, Tiring
        - Surgeon's field roll Tend Blood D6
        - Tar, canvas and copper patching kit Tend Hull D6

### CORE ABILITIES

#### THE SAME SAW
_The ship is a body. The body is a ship. Both can be fixed._ Your Tend rolls apply equally to flesh and timber — you never choose a specialism. Once per situation, when you spend a minute examining a person or a vessel, the GM tells you what is broken, how badly, and what it would take to fix it.

#### THE GRAND PROJECT
_It will take years. It may not be possible. You are building it anyway._ At character creation, define your grand project: a piece of engineering or surgery beyond what the Shackles believes possible — a thinking prosthetic, an unsinkable hull, a mechanical organ. Work with the GM to establish three milestones: discoveries to be made, materials to be sourced, techniques to be proven in play. Milestones are priced like major story beats — each costs a journey's worth of play, a rare material, or a real concession. When the project is complete, it works. Exactly as designed.

### MINOR ABILITIES

#### AMPUTATION
_This is not a last resort. Sometimes it is the most efficient solution._ Gain the Brave skill. Once per session, when a limb or extremity is the site of Blood fallout, you can remove it cleanly in one action: downgrade Major Blood fallout to Minor, or remove a Minor fallout entirely. The limb is gone. You carry everything you need to do this at any time.

#### THE SAW CUTS BOTH WAYS
_Flesh comes apart the way timber does — along lines you have spent a career learning to read. Taking a thing apart is the same knowledge as putting it back together, run backwards and without the care._ Gain the Brave skill. Your trade tools — bone saw, maul, pick, mallet — are proper weapons in your hands, with no improvised penalty. Once per situation, when you attack a living target at close range, your strike finds an anatomical weak point and gains the Piercing tag.

#### BONESETTER
_Most surgeons would not call it medicine. Most surgeons lose more patients._ Gain the Wilderness domain. You can treat wounds, infections and tropical disease with what grows or washes up anywhere in the Shackles; when treating Blood fallout with improvised materials in the field, your Tend dice increases by one step.

#### THE CARPENTER'S EYE
_Everything built is a diagram of how it fails._ Gain the Plunder skill. You can always tell where a structure's load-bearing points are, and you roll with mastery when stripping, shoring up or bringing down any structure — ship, fort, dock, ruin.

#### JOURNEYMAN'S PAPERS
Gain access to one of the following skills: Brave, Carouse, Command, Deceive, Endure, Navigate, Plunder, Reckon, Tend. You can take this advance more than once.

#### THE INDISPENSABLE
_Touch the cook and the crew grumbles. Touch the sawbones and the crew mutinies._ Gain +2 Reputation protection.

#### SALVAGE INSTINCT
_You know what the wreck is worth before the water settles._ Gain the Port domain. Once per session, when you encounter a wreck or damaged vessel, ask the GM what it is worth and who will pay for it, and they will tell you.

#### SHIPS' GRAVEYARDS
_Low tide is a market and you have the only key._ Gain the Shallows domain. When careening or repairing a beached vessel, the work takes half the usual time.

#### STEADY HANDS
_The deck heels, the guns roar, the lantern gutters. The stitch goes where you put it._ Gain the Endure skill. Work done with your hands is never considered Risky or Dangerous for you solely because of conditions — ship movement, battle, darkness, exhaustion.

#### TOOLS OF THE TRADE
_Your kit is your capital, and your skills convert to coin in any port in the world._ Gain +2 Gold protection.
...
#### YARD-TRAINED
_You apprenticed where the standards were written down._ Gain the Colonial domain. You know the navies' yards, stores, surgeries and paperwork from the inside, and your work passes their inspections — which opens doors a pirate's work should not.
...
- EQUIPMENT: Pick one:
    - Sleeve pistol Hunt D6, Ranged, One-Shot
    - Sword-cane Hunt D6, Brutal
    - Forger's kit of inks, seals and papers Deceive D6; sleeve-knife Hunt D6

### CORE ABILITIES

#### THE SURE THING
_Fate plays cards like everyone else; you palm its best card and keep it up your sleeve._ At any time, you may consume a resource and roll its dice; set the result aside. When you perform an action or inflict stress, but before you roll the dice to resolve it, you may replace any unrolled dice in your pool with the die you set aside. Once used in this manner, it is spent. If you have an unspent die set aside at the end of the session, mark Luck stress equal to the value showing on it.

#### DOUBLE OR NOTHING
_Fate plays cards like everyone else, and like everyone else, it can be hustled._ At any time, roll a D6. If the result is equal to or under your current Luck stress, clear that much stress from Luck and roll with mastery on your next action. If it's over, add that much stress to Luck.

### MINOR ABILITIES

#### THE BRIBED HARBOUR
_Officials are just locks with salaries._ Gain the Colonial domain. In any port you have worked for at least a session, you keep an official in your pocket: once per session, they suppress a record, misdirect a pursuit or warn you when authority turns your way. They are real, have their own interests, and can be endangered if pushed.

#### CARDSHARP'S FINGERS
_A moment of proximity, a moment of distraction._ Gain the Plunder skill. You can lift anything a person carries — keys, letters, the ring off their finger — given a moment of distraction; if the target is actively watching, roll Vanish, and on a partial success you take it but they notice something was wrong. Rigging a game of chance works the same way.

#### CONTROLLED PROFILE
_The face people know is a construction; damaging it costs them effort and buys you time._ Gain +2 Reputation protection.

#### EVERY ROOM'S NATIVE
_Tavern, council chamber, ship's mess or merchant ball._ Gain the Carouse skill. Roll with mastery when navigating social environments above or below your apparent station, because your station is whatever you need it to be right now.

#### FALSE FACE
_Your real name is a question the GM answers only if you choose to._ Gain the Vanish skill. You maintain two working identities; switching between them takes only a moment — a different coat, a different posture, a different name. People who know one cannot connect it to the other without dedicated investigation.

#### LOADED DICE
_You only bet on games you have already fixed._ Gain +2 Luck protection.

#### THE LONG GAME
Gain access to one of the following skills: Carouse, Command, Deceive, Hunt, Navigate, Plunder, Reckon, Tend, Vanish. You can take this advance more than once.

#### THE LONG CON'S END
_Every relationship you build is a position you can close. The mark who trusts you is the mark who lets you stand behind them._ Gain the Command skill. Once per session, when you attack a target you have cultivated over a scene or worked with THE HOOK, you roll with mastery and increase your stress dice by one step. They trusted you — that is the whole point.

#### NOSE FOR GOLD
_There is always money nearby. It sings to you._ Gain the Outlaw domain. Once per session, ask the GM where the nearest source of wealth is and they will tell you.

#### OLD HAUNTS
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Port, Colonial, Arcane. You can take this advance more than once.

#### TABLE STAKES
Gain +1 Protection in the Tide, Reputation, Luck or Gold resistance. You can take this advance more than once.

#### THE TELL
_New people are not new situations._ Gain the Reckon skill. When you observe someone for a few seconds, you can read their tells and discern their surface-level emotions — whether they're bluffing, frightened, greedy and so on.

#### THE SLEEVE
_A pistol in the cuff, a blade in the cane, a needle behind the lapel. The trick was never the weapon. The trick is that no one searched the man buying them a drink._ Gain the Hunt skill. Regardless of searches, disarmament or the conventions of the room, you always have a small, concealed, sufficient weapon. When you strike someone who does not yet know you are a threat, your first attack gains the Brutal tag.
...
- EQUIPMENT: Pick one:
    - Storm-lantern of blessed whale-oil Dark: Brave D6 / Lit: Brave D8, Obscuring, Dangerous
    - Breech-loading pistol and rite-knife Hunt D6, Ranged, Reload; Brave D6, Brutal
    - Scripture-inked bandages, blessed rum and a belaying pin Tend Blood D6; Brave D6

> **Name your god at character creation.** The Shackles' faiths are Golarion's. **Besmara** the Pirate Queen — plunder, sea monsters and the Code — is the obvious patron. **Gozreh** is the wind in the sail and the storm against the hull. **Cayden Cailean** keeps the free, the brave and the drunk. **Pharasma** is owed the rites of the drowned. **Hei Feng** answers in thunder and sudden temper. Or serve something older and less named that speaks in current and depth. Establish what worship looks like aboard your ship and one thing the god requires of you — the GM speaks for the god through THE CHART AND THE PRAYER, CONFESSOR and your omens.

### CORE ABILITIES

#### THE CHART AND THE PRAYER
_To you they are the same document: a chart more accurate than anything sold in the Shackles, and a record of every rite, omen and intervention you have witnessed on the water._ Once per session, when you consult it before acting, the GM gives you one true piece of information about what lies ahead — navigational, spiritual, or both. Once per journey, roll with mastery on a navigation challenge of your choosing.

#### MINISTRATIONS
_You offer the practical mercy of someone who knows the words that settle debts between souls and the water._ Once per session, lead your allies in a rite — a sea burial, a blessing before battle, rum poured for the dead (how you practise your faith is up to you). All player characters who took part can remove one Minor Blood or Tide fallout, or downgrade one Major Blood or Tide fallout to Minor, at the end of the rite. If you perform this rite whilst on a journey, add +D4 to the journey's resistance.

### MINOR ABILITIES

#### CONFESSOR
_People tell you things. You asked the right way, or your presence drew it out of them — and when no one will speak, the sky still does._ Gain the Outlaw domain. Once per session, someone unburdens themselves to you: an NPC in port confesses a fear, a plan or a thing they have done that they cannot tell anyone else; or, read at night, the sky gives an omen about a specific person, ship or course of action. The GM chooses the medium and answers honestly — in plain words, or in astronomical metaphor. Your god has opinions about betrayal and about silence in roughly equal measure.

#### DEAD RECKONING
_The bosun who lets the helmsman go down with fever loses the ship along with the soul._ Gain the Tend skill. You can treat exhaustion, exposure and the slow attrition of a hard passage with whatever is available at sea.

#### DIVINE WARD
_Whatever is trying to curse you must first explain to your god why it thinks it has the right. The conversation takes long enough to matter._ Gain +2 Tide protection.

#### THE GOD'S GIFTS
Gain access to one of the following skills: Brave, Carouse, Command, Endure, Hunt, Navigate, Plunder, Reckon, Tend. You can take this advance more than once.

#### LAST RITES
_The god keeps what it is given properly._ Gain the Port domain. When you preside over a death — a funeral, a burial, a sailor gone over the side — you may ask the deceased's spirit a single question before your god takes it, and the dead so honoured cannot easily be raised against their will.

#### LIAR'S BURDEN
_The sea does not tolerate false witness, and neither does your god._ Gain the Reckon skill. If you suspect an NPC is lying to you, roll Reckon+Faith. On a success, if they were lying, they mark D4 stress as their mouth fills with seawater.

#### PILGRIM ROUTES
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Faith, Arcane, Port, Ruins. You can take this advance more than once.

#### SACRED TATTOO
_Every passage survived is inked into your skin at the next port, a ledger the universe can read and finds balanced._ Gain +2 Luck protection.

#### SCRIPTURE OF SALT
_You have argued the god's requirements with captains, cultists and the dying._ Gain the Command skill. When you invoke what the god requires in conversation with those who share — or fear — your faith, roll with mastery.

#### SERMON ON THE DECK
_Your faith is shared meals, songs off-watch, and the last hour before a hard day._ Gain the Carouse skill. Once per session, when you drink, feast or mark a moment alongside an ally in the god's name, they gain +1 Tide protection until the end of the session.

#### BLESSED STEEL
_The rite-knife that opens a sea-burial opens other things. The god does not mind which._ Gain the Brave skill. Your consecrated weapon — rite-knife, storm-lantern, belaying pin — is a true weapon in your hands. Once per situation, when you strike someone who has broken faith, oath or the Code — a mutineer, an oathbreaker, a desecrator — your attack gains the Brutal tag. The god keeps the books.

#### UNWAVERING FAITH
Gain +1 Protection in the Tide, Reputation, Luck or Gold resistance. You can take this advance more than once.

#### WEATHERWISE
_The best weather intelligence comes from the water itself: the temperature of the current, the smell of the air, the silence of the seabirds an hour before the squall._ Gain the Deepwater domain. When you have read the sea and sky before setting out, the first weather hazard of the journey inflicts its stress on you and your crew one dice size smaller.
...
- EQUIPMENT: Pick one:
    - Coral-hilted ritual knife Brave D6, Bloodbound
    - Salvaged carbine, shot etched with wave-sigils Hunt D6, Ranged, Reload
    - Sea-chest of brines, weeds and leeches Tend Blood D6

### CORE ABILITIES

#### THE PACT
_It is real, it has wants, and it speaks in signs rather than words._ At character creation, name your pact entity — something drawn from the Eye, the deeps, or the storm. Once per session, ask it one direct question; the GM answers honestly, in the language of omens. When you act in accordance with what it wants, remove D4 Tide stress. When you act against it, mark D6 Tide stress.

#### SEA-CHANGE
_Your body is half the sea's already._ Whenever you want to, or when you suffer Major fallout, you enter your true form — scaled, kelp-wreathed, eyes like drowned moons; describe it. In your true form, you roll with mastery on Brave and Hunt checks, but all other checks become Risky. At the end of the current situation, you revert to your mortal shape.

### MINOR ABILITIES

#### BLOOD-QUIET
_The deep water beats black within your veins._ Gain the Vanish skill. When you are in your SEA-CHANGE form, Vanish rolls are no longer Risky.

#### DEEPSPEAK
_Not language — intent and image._ Gain the Faith domain. Besmara's sacred animals treat you as kin, and once per session you can put one question to a sea-creature about what it has seen or sensed nearby; it answers as best its small mind allows.

#### THE DROWNED PLACES
_The sea showed you where it keeps what it takes._ Gain the Ruins domain. Once per session, ask the GM whether anything drowned — wreck, ruin or sunken thing — lies beneath your keel and they will tell you; the pact then lets you breathe water for the rest of the situation to walk its halls.

#### FAMILIAR
_A gull, a crab, a serpentine thing that shouldn't exist._ Gain the Hunt skill. You have a bound creature that serves as your eyes and messenger; it can travel up to a day's sail from you and return, and you can mark D4 Tide stress to see through its senses.

#### HEX SIGHT
_You can smell a working the way sailors smell weather._ Gain the Reckon skill. You always know when you are in the presence of active magic, curses or supernatural attention; identifying its nature is a Reckon roll, made with mastery.

#### OLD WATERS
Gain access to one of the following domains: Deepwater, Shallows, Outlaw, Arcane, Faith, Ruins, Wilderness. You can take this advance more than once.

#### THE PRIOR CLAIM
_Whatever tries to curse you must first negotiate with the thing that holds the lien._ Gain +2 Tide protection.

#### SALT-TAUGHT
Gain access to one of the following skills: Brave, Command, Deceive, Endure, Hunt, Navigate, Reckon, Tend, Vanish. You can take this advance more than once.

#### STORM-DEBT
_The weather owes you, and you collect in instalments._ Gain the Deepwater domain. Once per session, while at sea, call a weather working — a squall, a fog bank, a sudden calm. It costs nothing and lasts until the end of the situation.

#### TIDEBLOOD
_What would fester on land closes clean in open water._ Gain the Endure skill. Once per session, when you immerse yourself in seawater after taking Blood stress, remove D4 Blood stress. You can survive underwater twice as long as a normal person.

#### WARDED AND WATCHED
Gain +1 Protection in the Blood, Tide, Reputation or Luck resistance. You can take this advance more than once.

#### THE WITCH'S DUE
_No one laughs twice._ Gain +2 Reputation protection.

#### WITCH'S HANDS
_The sea is a pharmacopoeia for those it has claimed, and you have learned to share what it gives you._ Gain the Tend skill. When you have time to prepare, you can turn a resource with the Deepwater or Wilderness domain into a draught; when drunk, it removes Blood or Tide stress equal to its dice size minus one step — choose which when you brew it. In addition, once per situation you may treat a nearby ally directly with sea-physick, removing D4 Blood stress without a prepared draught.
...
The peoples of the Shackles fall into two groups, and they answer the "who are you" question differently.

**Cultures** are for the "baseline" folk of the Inner Sea — **humans, elves, half-elves, and the like**. For these peoples, species barely matters; what matters is the *culture* that raised you. **There is no "human" or "elf" ancestry in this game** — instead you choose a culture pool, and your exact species within it is yours to picture. A Chelaxian may be human or elf; a Shackleborn is whatever blood the islands have mixed. Pick the upbringing, not the bloodline.

**Kindreds** are peoples set apart by their very nature — their bodies, instincts, or origins mark them out, and they carry their own culture with them wherever the tide takes them. A kindred *is* your people.
...
- You came up in the alleys and wharves of **Port Peril**, running messages and lifting purses before you could shave. Whose crew or gang raised you in place of the parents you barely remember — and what do you still owe them?
- You were one of dozens of children aboard a single great pirate vessel, raised collectively by a crew who were closer than any blood. Something happened to that ship and most of that crew. What was it, and what do you carry from it?
- You grew up in a tiny anchorage on a forgotten island, far from **Quent** or any place that matters, and left the day a ship would take you. What were you running toward, and what did you swear you'd never become?

### Names

Shackleborn names are magpie things, stitched from every culture that ever made port: a Chelish given name, a Mwangi surname, a nickname earned in a tavern that outlives both. Most go by the nickname. Examples: *Cinder, Marisol Okonkwo, Tam Greel, Quintana, Bilge-Rat Ojo, Sefa "Two-Knives" Castellan.*

> Many Shackleborn are renamed at least once by a crew — a deed-name or an insult that stuck. The birth name becomes a thing you only tell people you trust.

### Trinkets

*Roll twice on a d20 and keep both.*

| d20 | Trinket |
|---|---|
| 1 | A child's drawing of a ship, kept folded so long the creases are soft as cloth |
| 2 | A string of mismatched buttons, each one cut from the coat of a different dead man |
| 3 | The Pirate Code, copied out in your own crooked hand, with two articles you added yourself |
| 4 | A worn knucklebone die that has never once rolled a one for you |
| 5 | A key to a door on an island that has since burned down |
| 6 | A scar across your palm from the oath that made you part of your first crew |
| 7 | Your share-token from your first real prize, drilled through and worn on a cord |
| 8 | A pet harbour rat, fat and clever and utterly loyal (name it) |
| 9 | A tin whistle that plays the three tunes every Shackles child knows |
| 10 | A list of every port you've made, with a private mark beside the ones you can't go back to |
| 11 | A wanted notice — yours — that gets the spelling of your name wrong, which you find funny |
| 12 | A length of rope tied in the particular knot your mother used; you don't know what it means |
| 13 | A handful of foreign coins, none of them legal tender anywhere you've been |
| 14 | A shark-tooth charm, given for luck by someone who then had none |
| 15 | A cork from the first bottle you were ever allowed to finish |
| 16 | A folding knife worn paper-thin from sharpening, that you will never replace (name it) |
| 17 | A letter of marque you stole, blank where the captain's name should be |
| 18 | A small idol of Besmara, the paint long worn off her face |
| 19 | A bird's skull, a sea-glass bead, a brass screw — the pockets of someone who keeps everything |
| 20 | A debt-marker in your own hand, owed to a person you can no longer find |
...
- A slaving operation working out of **Bloodcove** took people from your village — perhaps including you, before you got free. You sail in part to make that trade bleed. What did you lose to it, and how close have you come to the ones responsible?
- You were a pilot and free-diver whose knowledge of the reefs was worth a fortune, and a Free Captain offered you a berth rather than a chain for it. Which captain, and do you trust the bargain you struck?
- You left the coast willingly, drawn by a story the elders tell about something out beyond the charted water — a drowned place, a debt the sea is owed, a song under the waves. What did you go looking for, and has the sea begun to answer?

### Names

Bonuwat names carry weight — a birth name from the family, and often a second name earned from the sea itself: a thing you survived, a creature you faced, a reef you alone can run. Examples: *Adaeze, Kofi Reef-Walker, Ngozi, Seun, Yetunde Deep-Breath, Abara Two-Tides.*

> Many Bonuwat sailors take a sea-name in addition to their birth name; it is the sea-name that is used among a crew, and the birth name that is used among kin.
...
| d20 | Trinket |
|---|---|
| 1 | A free-diver's weight-belt of carved stone beads, each one a depth you have reached and survived |
| 2 | A pouch of indigo dye worth more than most pirates carry in coin, that you will not sell |
| 3 | A reef-map drawn on dried sharkskin, in a notation only your people read |
| 4 | A grandmother's earring, the match to which a Chelish factor wears and does not know its meaning |
| 5 | A whistle carved from a great fish's bone, that carries underwater |
| 6 | A scar in the shape of a creature's teeth, from the dive that earned your sea-name |
| 7 | A bill of sale — your own, voided — that you kept instead of burning |
| 8 | A length of net you can mend in the dark, knot-perfect, the last your village made |
| 9 | A small living thing that rode home on your shoulder from a far reef (name it) |
| 10 | A jar of coast-water from the exact place you were born, going slowly stale |
| 11 | A list of the drowned, recited each new moon, that you have added to in your own hand |
| 12 | A diving-knife so old the bone handle has taken the shape of your grip (name it) |
| 13 | A piece of pale coral that grew in the shape of a hand |
| 14 | A Consortium survey-stake, pulled up and kept, with their mark you've half-scratched out |
| 15 | A song you are the last living person who knows |
| 16 | A bracelet of shark teeth, one of them not from any shark you can name |
| 17 | An offering-bowl for Gozreh, salt-crusted, used every dawn you can manage it |
| 18 | A sealed letter to an elder back home that you have never found a ship to carry |
| 19 | A child's first diving-stone, that you are keeping for someone not yet old enough |
| 20 | A pearl the size of a knuckle, the price of which is the thing you can never tell |
...
- You served aboard a Chelish man-o-war out of **Corentyn** before your ship was taken — and the Free Captains offered you a berth instead of the deep. What did you do to earn that, when your fellow officers earned a knife?
- You fled a contract — an indenture, a betrothal, a debt sworn before a devil — that is still, technically, legally binding. Who in Cheliax still holds your paper, and what will it cost when they send someone to collect?
- You came to the Shackles believing in the empire and meaning to bring it order, and somewhere along the way you changed sides for real. What did you see that turned you, and who from your old life would put a price on your head if they knew?

### Names

Chelish names are formal, layered, and faintly archaic — a given name, a house name, often a saint's or ancestor's name carried like a debt. Out here you have probably shortened it, or thrown away the house name entirely. Examples: *Aurelio Thrune-by-marriage, Severa, Maddox Vell, Cordelia Anvanus, Just "Vespers," Tace Drovost.*

> A Chelish family name still opens doors and closes throats across the Inner Sea. Many defectors drop theirs and keep only a given name — but the ones hunting them know the old one.
...
| d20 | Trinket |
|---|---|
| 1 | A signet ring of a noble house, filed flat so the crest no longer reads |
| 2 | A naval officer's spyglass, regulation issue, with your old rank still engraved |
| 3 | A letter of indenture or betrothal, the seal broken, that you cannot quite bring yourself to burn |
| 4 | A duelling glove of fine leather, kept for a challenge you intend to deliver one day |
| 5 | A child's catechism of the empire, annotated in the margins by a younger, truer believer |
| 6 | A vial of holy-or-unholy water you can no longer remember which |
| 7 | A miniature portrait of someone you left, painted so well it still hurts to open |
| 8 | A set of forger's tools — fine nibs, official wax, a stolen seal-matrix |
| 9 | A medal for service you are now ashamed of, that you keep to stay ashamed |
| 10 | A contract written in a hand that is not human, that you took when you ran |
| 11 | A clever folding razor, monogrammed, that has shaved three captains and cut one throat |
| 12 | A cipher-key to a code the Chelish navy used the year you deserted |
| 13 | A pressed flower from a garden in Egorian that no longer exists |
| 14 | A worn copy of the duelling forms, every page memorised, carried out of habit |
| 15 | A debt-marker you hold against a Chelish officer who does not yet know you survived |
| 16 | A small, expensive, useless thing — a porcelain cat, a jewelled thimble — that you stole on the way out (name it) |
| 17 | A list of the names of everyone your old ship took, that you are slowly trying to find |
| 18 | A confessor's stole, taken from a man who would not have given it |
| 19 | A perfectly tailored coat, salt-ruined now, that you wear anyway |
| 20 | A sealed letter of confession you have written but not decided whether to send |

## Small Folk

*A kindred, not one people: halflings, gnomes, dwarves, and every other small civilised folk the Inner Sea reckons "ordinary" — as opposed to the goblins and kobolds it calls vermin.*

You are one of the small peoples — the ones the tall world finds useful, underestimates, and forgets to fear. Maybe you are a **halfling**, born into a Chelish household that owned you or one generation removed from one, who got over a wall and never looked back. Maybe you are a **gnome**, fey-touched and restless, forever one new wonder ahead of the grey creeping numbness your people call the Bleaching, and the deck of a pirate ship is the most interesting thing you have ever found. Maybe you are a **dwarf**, exiled from the stone-holds by oath or feud or sheer wanderlust, carrying your craft and your grudges out onto a sea your ancestors never trusted. What you share is not blood but *position*: you are small in a world built for the big, and you have learned that being overlooked is a kind of armour, and that the small hands get into the places the large ones cannot.

### Background Questions

- You came up under a roof that did not consider you a full person — a Chelish estate near **Corentyn**, an Aspis counting-house in **Bloodcove**, a dwarf-hold that cast you out. Who decided your size was the same as your worth, and how close have they come to finding you since?
- You are chasing something the tall world doesn't value enough to guard properly — a wonder, a craft, a freedom, a debt of honour older than anyone alive. What is it, and what has the chase already cost you?
- You were born free in the Shackles, small among giants, and learned early that the deck doesn't care how tall you are if your hands are quick and your nerve holds. Who taught you that, and what did you have to prove to them?

### Names

Small Folk names span their peoples: halfling names are warm and plain, often a trade or a place (*Pim Saltcellar, Lula, Mosey*); gnome names are long, musical, and collected like keepsakes, usually shortened by everyone else (*Fonkin, Zither, Bee*); dwarf names are hard and clan-bound, an honorific or a hold attached (*Hekka Stonebound, Durgan, Vess Oath-Kept*). Examples across the kindred: *Pim, Bee Quick-Fingers, Durgan No-Hold, Hessa Freeborn, Tock, Corrin Tallows.*

> Many Small Folk carry two names — the one their people gave them and the one the tall world can be bothered to pronounce. Halflings born to bondage often choose a free name on getting out; gnomes change theirs whenever the old one stops delighting them.
...
| d20 | Trinket |
|---|---|
| 1 | A household tag, collar, or hold-brand — cut through, filed off, or pried loose — kept as a reminder of what you left |
| 2 | A recipe, a formula, or a clan-mark recorded in three hands: your grandmother's, your mother's, and now yours |
| 3 | A skeleton key you cut yourself, that opens more than it has any right to |
| 4 | A tiny, intricate, useless mechanism — a gnome's whim — that does one charming thing and nothing else |
| 5 | A page torn from a ledger, an oath-tablet, or a property-roll with your old name on it, stolen on the way out |
| 6 | A set of weighted dice you only use on people who deserve it |
| 7 | A list of names — others still inside the house, hold, or cage you escaped — that you are working down, one at a time |
| 8 | A small animal that runs the rat-lines and answers only to you (name it) |
| 9 | A free-paper or forged writ of passage, made out to a person who never existed |
| 10 | A spoon, a chisel, or a thimble worn thin — the one tool of your old life that made it out with you |
| 11 | An iron token of Cayden Cailean, patron of the freed, that you rub before anything dangerous |
| 12 | A wanted notice offering a reward "for the return of property," meaning you, that you carry out of spite |
| 13 | A coil of fine cord and a grapple small enough to hide in a fist |
| 14 | A pressed sprig, a chip of stone, or a fading sketch of the one good thing from where you grew up |
| 15 | A pouch of something the Bleaching can't touch — a colour, a song, a joke — that a gnome carries against the grey |
| 16 | A whistle-code, taught by runaways or by miners, that means *get out now* in any place that knows it |
| 17 | A debt owed you by someone you freed or saved, who swore they'd come when you called |
| 18 | A craftsman's kit — needle and palm, files and picks, lockwork tools — small enough to vanish, good enough to live on |
| 19 | A jar of good salt or fine ale, because you swore you would never again take what they handed you |
| 20 | The first coin you ever earned as your own person, that you will starve before you spend |

## Goblinkin

*A kindred, not one people: goblins, kobolds, and the other small folk the Inner Sea does not call "ordinary" but "vermin" — and hunts accordingly.*

You are small like the halflings and gnomes, but where the world merely *overlooks* them, it actively wants you *dead*. Maybe you are a **goblin** — sharp-toothed, fire-mad, gleefully alive — raised in a warren that the nearest town burned out at least once in your memory, who learned that the only safe place is moving and the only currency is being too useful or too funny to kill. Maybe you are a **kobold** — scaled, clever, and proud — bred to traps and tunnels and the worship of things much larger than yourself, until you slipped your warren's hierarchy and struck out to be nobody's small and expendable cog. The respectable peoples treat you as a problem with legs; the Free Captains, gloriously, do not care, so long as you can fit down the hawsehole to clear a fouled cable, rig a trap no boarder expects, or do the loud dangerous thing nobody taller will volunteer for. You have spent your whole life being underestimated and hunted. On a pirate deck, for the first time, the first half is an advantage and the second half is just *Tuesday*.

### Background Questions

- A town, a baron, or a "pest-control" bounty out of a colonial port like **Bloodcove** put a price on your whole warren — maybe on you specifically. What happened to the rest of them, and what did you do that they still remember?
- You are dangerously, delightedly good at the thing that scares everyone else — fire, traps, heights, the powder magazine, the narrow flooded crawlspace. What's your specialty, and what has it already cost you or someone near you?
- You attached yourself to this crew the way your kind always survives: by being indispensable to someone bigger. Who did you decide to be useful to, do they know it's mutual, and what happens the day they stop needing you?

### Names

Goblin names are short, percussive, and often gross or boastful, earned and re-earned by deeds (*Snag, Chuff, Reekfinger, Last*); kobold names hiss and click, frequently invoking a draconic patron or a clever trap they're proud of (*Skritt, Vex, Az-the-Snare, Little Tooth*). Examples across the kindred: *Snag, Skritt, Reek, Vex Trapwright, Chuff, Az.*

> Goblins rename themselves constantly — after a meal, a fire, a near-death — and sing the new name until it sticks. Kobolds guard their true-name and offer the surface a use-name, often the name of the trap or trick they're best at.
...
| d20 | Trinket |
|---|---|
| 1 | A tinderbox you made yourself that lights wet, in wind, on the first strike, always — your proudest possession |
| 2 | A string of "treasures" the tall folk would call rubbish: a bent spoon, a doll's eye, a perfect pebble, a tooth |
| 3 | A trap, in miniature, that actually works, which you set off to demonstrate at the worst social moments |
| 4 | A scorch-scar with a story you tell three different ways depending on the audience |
| 5 | A tally of every time you should have died, scratched somewhere on your person, that you are quietly proud of |
| 6 | A whistle pitched so high only your kind and the ship's dogs flinch at it |
| 7 | A song — yours, improvised, endless — about everyone aboard, updated after every fight |
| 8 | A small mean creature even uglier than you, that you love ferociously (name it) |
| 9 | A wanted poster offering coin for you "dead or in a sack," that you have signed |
| 10 | A length of fuse-cord coiled where a sensible person would not keep fuse-cord |
| 11 | A draconic scale, a dragon's cast-off tooth, or a relic of the big thing your warren worshipped |
| 12 | A set of picks and pry-bars worn from a lifetime of getting into and out of places |
| 13 | A jar of something that should not be in a jar, that you are keeping for "an emergency" |
| 14 | The charred remains of the one thing you ran back into the fire to save |
| 15 | A map of a town's sewers, drains, and gaps, drawn from the inside, that has saved your life twice |
| 16 | A "lucky" object that has been on fire, underwater, and through a cannon's near-miss, and survived like you |
| 17 | A debt of loyalty to one taller person who, once, did not try to kill you — and you have never forgotten it |
| 18 | A pouch of caltrops, fish-hooks, and broken glass, for making any floor regret following you across it |
| 19 | A trophy from the thing that was supposed to eat you, taken from the wrong end of it |
| 20 | A secret way off this ship that you have not told anyone about, just in case |

## Big Folk

*A kindred, not one people: half-orcs, minotaurs, hobgoblins, and the other large, strong, martial folk the Inner Sea greets with a drawn weapon — and a job offer.*

You are one of the big peoples, built on a scale the polite world finds threatening and the working world finds invaluable. Maybe you are a **half-orc**, born from a violence or a love the cities cannot bear to look at, too orc for the humans and too human for the orcs, welcome nowhere a roof keeps off the rain. Maybe you are a **minotaur**, raised among the old labyrinth-ruins, carrying a strength and a shame and a sense of direction that never fails even when everything else does. Maybe you are a **hobgoblin**, bred for a war-society of iron discipline and brutal order, who looked at the rank ahead of you and the chain around your neck and decided to desert the whole arrangement. What you share is that the Inner Sea taught you your body was a problem to be managed — and then you found a deck, where the only questions are *can you haul, can you fight, will you hold the line*, and for the first time the answer being yes made you an asset instead of an omen.

### Background Questions

- You were muscle for someone — a Chelish workhouse, a hobgoblin legion, a gang on the docks of a colonial port — until you decided your strength would only ever work for *you* again. Who did you break with to get free, and are they still looking?
- You carry a discipline or a code from where you came up — a soldier's order, a labyrinth-keeper's patience, a half-orc's hard-won restraint — that the chaos of piracy tests every single day. What is it, and what happens on the day it finally breaks?
- You are trying to prove something — that you are more than the fist people reach for, more than the monster the stories promised. What's the thing you're chasing, and what will it take before you believe you've done it?

### Names

Big Folk names run hard and plain, or defiantly proud: half-orcs take a forgettable human name to pass or a reclaimed deed-name to stop passing; minotaurs carry a birth-name and a place-name from the maze that raised them; hobgoblins are named by rank and unit until they shed it for one of their own. Examples across the kindred: *Grust, Oggun Pier-Breaker, Mara, Korthax of the Sunken Maze, Vell, Iron-Twelve "Twelve."*

> A Big Folk raised among humans often carries a deliberately unremarkable name; one raised among a crew often wears the name the crew gave them, like a flag. A deserter hobgoblin's first free act is usually choosing a name that is not a number.
...
| d20 | Trinket |
|---|---|
| 1 | A filed-down tusk, sawn horn-tip, or cut rank-braid — a piece of yourself you removed to pass, and kept because you stopped |
| 2 | A workhouse token, slave-tally, or legion service-disc, the number still legible, that you've never been able to throw away |
| 3 | A belaying pin worn smooth as a handle, that has settled more arguments than the captain |
| 4 | A child's toy you carved for someone, never delivered |
| 5 | A list of everyone who ever called you a thing instead of a name, kept for no reason you'll admit |
| 6 | A surprisingly delicate piece of scrimshaw or knotwork, your own work, that no one believes you made |
| 7 | A field-manual, drill-book, or labyrinth-map you were trained on, annotated in the margins by a younger, truer believer |
| 8 | A big ugly animal that chose you and will not be un-chosen (name it) |
| 9 | A medal or commendation from a force that then refused to let you truly belong |
| 10 | A folded square of cloth — a flag, a banner, a blanket — from the first crew or unit that took you in |
| 11 | A wanted notice that describes you only as "a large half-orc / a minotaur / a hobgoblin," which you find insulting |
| 12 | A pair of brass knuckles or a knuckle-bone, cast or carved from a chain you used to wear |
| 13 | A letter from a parent or a sworn-sibling, read so often the fold has worn through the page |
| 14 | A tooth, a tine, or a tag that isn't yours, taken from someone who learned not to test you twice |
| 15 | A drinking horn that holds exactly as much as you can carry and still climb the rigging |
| 16 | A small shrine to Cayden Cailean, the Accidental God, who took no one's pedigree into account |
| 17 | A length of anchor-chain you can still lift one-handed, that you keep to be sure you still can |
| 18 | A debt freely owed to you by a person who, for once, was glad to be in your debt |
| 19 | A ball of red thread or a knotted cord — the trick that gets you out of any maze, or any port, the same way every time |
| 20 | A name carved into a beam below decks — yours — because you wanted there to be proof you were here |

## The Made

*A kindred, not one people: androids, automatons, homunculi, and the other thinking things that were built rather than born — and woke up anyway.*

You were not born. You were *made* — assembled, cast, grown in a vat, wound up, or breathed into being by someone who wanted a tool and got a person instead. Maybe you are an **android**, a synthetic body of ageless flesh and buried machinery, carrying a soul that has worn other bodies before this one and will move on after, hunting in this single lifetime for what it means to be a *self* and not a thing. Maybe you are an **automaton**, a frame of brass and old enchantment, a soldier or a servant whose makers are long dust, still walking because no one ever told you that you could stop. Maybe you are a **homunculus**, a small made-thing built to serve a master who is dead, or worse, *not* dead, and still believes they own you. The Inner Sea cannot decide whether you are property, miracle, or abomination, and reaches for a different one of the three depending on who can profit. The Shackles, which is built entirely of people who refused to be owned, is the one place that looks at a made thing claiming itself a free person and simply says: *prove it on the next watch.*

### Background Questions

- You had a maker or an owner — a Chelish artificer, a Numerian salvage-crew, a wizard whose tower you walked out of. Are they dead, hunting you, or worst of all still legally entitled to you under Inner Sea law, and how close have they come to collecting?
- You are trying to become — or to prove you already are — a real person, with all the mess that entails. What specifically are you chasing (a feeling, a choice, a death you can call your own), and what have you done that frightened *you* by how alive it was?
- The crew took a while to decide you weren't a clever machine playing at a soul. Who vouched for you first, what did you do to earn it, and what do you owe them now?

### Names

The Made are named in three ways: a maker's designation, dry and functional (*Unit Seven, Cataloguer, Vessel-9*); a name a Made chooses on waking, often abstract or aspirational (*Vigil, Ash, Nine, Tuesday, Hope*); or a name a crew gives them, affectionate and plain (*Tin, Brass, Doc*). Examples: *Vigil, Unit Seven (now just "Seven"), Ash, Brass, Cataloguer, Tuesday.*

> Many of the Made keep their maker's designation the way a freed person keeps an old scar — not from love, but to remember. Choosing a *new* name is, for most, the first act that was truly their own.
...
| d20 | Trinket |
|---|---|
| 1 | Your maker's mark, stamped or etched somewhere on your frame, that you have tried and failed to file off |
| 2 | A single component you replaced yourself, badly, the first time you chose to keep living |
| 3 | A logbook in your own hand, beginning the day you woke, that you are using to find out who you are |
| 4 | A bill of sale, a commission, or a deactivation order with your designation on it |
| 5 | The tools and oil that keep you running, which you guard more carefully than any weapon |
| 6 | A small repeating fault — a tic, a hum, a flicker — that you have stopped trying to fix because it feels like *you* |
| 7 | A list of human things you are teaching yourself to do convincingly: blinking, flinching, lying, grieving |
| 8 | A wind-up bird, a lesser made-thing, that you tend like a child of your own (name it) |
| 9 | A keepsake from a previous life your soul half-remembers but your body never lived |
| 10 | The last order your dead maker gave you, that you are deciding whether you still have to obey |
| 11 | A relic of Numeria or some other place of fallen sky-metal, that hums when you hold it |
| 12 | A perfectly kept human object — a comb, a ring, a pipe — belonging to no one you ever met, that you find comforting |
| 13 | A diagram of your own internals that you did not draw and do not fully understand |
| 14 | A "wanted" notice listing you as *recovered property*, that you carry to remind yourself it's a lie |
| 15 | A charm or icon a religious crewmate pressed on you, insisting you have a soul; you have not thrown it away |
| 16 | A jar of the vat-fluid, sky-metal filings, or clockwork dust you woke from |
| 17 | A debt owed to you by the first person who treated you as a person; you intend to never call it in |
| 18 | A small idol — perhaps to Brigh, goddess of invention, who might be the nearest thing you have to a maker who loves you |
| 19 | A scrap of music, a joke, or a poem that made you feel something the first time, that you replay deliberately |
| 20 | A self-destruct phrase, a kill-word, or a shutdown command your maker built into you, that someone out there still knows |

## Beast-folk

*A kindred, not one people: tengu, catfolk, ratfolk, merfolk, naga, and every other folk who wear an animal's shape and an animal's instincts under a thinking mind.*

You are one of the beast-folk — a person the tall, smooth, hairless world calls an *it* before it calls you anything else, and you have a creature's patience for that particular insult. Maybe you are **tengu**, crow-folk who live in the cracks of other people's cities and collect words the way magpies collect bright things. Maybe you are **catfolk** of the Amurrun, curious and proud and built for the rigging, landing on your feet out of habits older than language. Maybe you are **ratfolk** of the Ysoki, a tinker and a hoarder and a survivor who can fit through a gap the size of your own skull and has done it more than once. Maybe you are **merfolk**, the sea's own, who can only walk ashore by a bargain and pays for every hour of it. Maybe you are **naga**, serpentine and uncanny and far older than you look, carrying a coil of ancient memory the human world finds frightening. What you share is the animal under the skin — the instinct that fires before thought, the senses that read a room or a reef before anyone speaks — and the knowledge that the sea, at least, treats every kind of creature with the same honest indifference.

### Background Questions

- You worked a great port — **Port Peril**, **Quent**, somewhere busier and crueller — in the spaces the tall folk overlook: the rigging, the bilges, the rumour-rich dark of the wharves. What did your senses catch there that you weren't meant to, and who's still angry about it?
- Your body answers to the sea in a way the others' don't — gills, claws, a tail, a coil, an instinct for current and weather — and it is both your gift and your leash. What can you do that they can't, and what does it cost you that they'll never understand?
- You come from a beast-folk community with its own ways and its own long memory — a tengu wharf-clan, an Amurrun pride, an Ysoki warren, a drowned merfolk court, a naga's ancient solitude. What does it expect of you out here, and what do you owe it?

### Names

Beast-folk names follow their peoples and their instincts: tengu collect *good words* and onomatopoeia (*Kaw, Rattle, Two-Penny*); catfolk take lithe, proud names, often a hunt-name earned (*Sefu, Quick-Paw, Nadira*); ratfolk run to practical, scurrying names and nicknames (*Tisk, Gnaw, Pellet*); merfolk and naga carry long, liquid, half-unpronounceable true-names and give the surface a short one (*Vael, Ssira, the one they call "Tide"*). Examples across the kindred: *Kaw, Sefu Nine-Lives, Tisk, Vael of the Drowned Court, Ssirahl "Tide," Hark.*

> Most beast-folk keep a true-name in their own tongue and hand the surface world a *deck-name* — a sound, a trait, a word they liked. The true-name is for kin and for the sea; the deck-name is for everyone else, and may change with the voyage.
...
| d20 | Trinket |
|---|---|
| 1 | A hoard of small things — a button, a coin, a tooth, a scale, a bead — sorted by no logic but your own |
| 2 | A notebook (or a memory) of phrases in nine tongues, each labelled with where you'd use it and on whom |
| 3 | A whisker, a feather, a shed scale, or a tuft of fur that is *not* one of yours — you won't say whose |
| 4 | A set of lockpicks filed from bone, or claws you keep filed sharp for exactly that purpose |
| 5 | A bargain-token from the sea — coral, a smooth stone, a knotted weed — that lets you keep walking ashore, for now |
| 6 | A password, scent-mark, or call-sign to a place in a port you can no longer safely enter |
| 7 | A ledger of debts owed *to* you in favours and secrets, which you consider better than coin |
| 8 | A smaller beast, not of your kind, that you have half-tamed and wholly spoiled (name it) |
| 9 | A coin or relic from a country that no longer exists, kept because the shape of it is beautiful |
| 10 | A map of a place's roofs, bilges, currents, or burrows — the hidden ways, not the streets — marked for a fast escape |
| 11 | A charm against drowning, or against drying out, given by an elder, that has either worked perfectly or never been tested |
| 12 | A song, a scent, or a story you collected off a dying sailor that you have never shared |
| 13 | A coil of memory too old to be yours — a naga's inheritance, a thing you know without learning |
| 14 | A wanted notice for you that gets your species wrong, which offends you professionally |
| 15 | A jar of water from the exact stretch of sea or river you were born to, going slowly stale |
| 16 | A trophy from a hunt — a tooth, a tine, a band — that means more to you than any of them will guess |
| 17 | A scrap bearing a single word, sigil, or scent-trace in a script no one you've shown can read |
| 18 | A small idol of Norgorber, god of secrets, who appreciates a creature that knows how to keep them |
| 19 | A whistle-, scent-, or tail-signal language, taught by your people, that carries across a crowded deck as nothing the tall folk notice |
| 20 | A secret you are carrying for someone, sealed and unread, that you have been paid not to open |

## Planetouched

*A kindred, not one people: tieflings, aasimars, ifrits, undines, oreads, sylphs, and everyone else born with a plane in their blood — marked, at birth, by a heritage they did not choose.*

Somewhere up your bloodline a door was left open — to the Hells, to the heavens, to the elemental deeps where fire and water and stone are alive — and it left its sign on you. Maybe you are a **tiefling**, fiend-blooded, born with horns or hooves or eyes like coals into a Cheliax that breeds the infernal into its noble lines and then despises what it makes. Maybe you are an **aasimar**, touched by something brighter, with a glow under the skin and a destiny everyone keeps trying to write for you. Maybe you are **elemental-blooded** — an ifrit who runs hot and angry, an undine whose skin is always faintly wet, an oread heavy and slow as the seabed, a sylph the wind seems to follow — kin to forces older than any god's quarrel. What you all share is that strangers read your *birth* off your face before you open your mouth, and decide they already know what you are. They are wrong, and proving it is the work of a life. The Shackles, which is full of people refusing to be the thing they were born into, is the one sea where your blood is just one more rumour about you, no truer than the rest.

### Background Questions

- You were born into a **Chelish** house that dabbles in the infernal, and your blood paid for someone else's bargain — a mark, a debt, an expectation. Whose deal are you carrying, and what did you do when you decided it was not yours to honour?
- Your heritage showed early, in a Shackles port that took it for an omen — good or ill — and treated you accordingly ever since. Where, what did they decide you were, and how have you used or fought that ever since?
- The plane in your blood is *calling* — a pull toward the Eye, the deep, a far fire, a voice that claims you as kin — and you are not sure whether to answer it or drown it. What calls you, and what have you already done to keep from going?

### Names

Planetouched names run three ways: a name given *for* the mark (hellish epithets, luminous celestial names, element-words); a "virtue name" a family hangs on a tiefling child like an apology (*Mercy, Temperance, Owed*); or a plain name chosen in defiance of all of it. Examples across the kindred: *Ember, Mercy Vane, Tide-in-the-Blood, Cassiel, Stone, Just "Smoke."*

> Many planetouched carry the name their blood earned them and a second they chose — and answer to whichever tells them more about the person using it.
...
| d20 | Trinket |
|---|---|
| 1 | A filed-down horn, a chipped hoof-cap, or a covered patch of glowing skin — a piece of the mark you tried to hide, and kept |
| 2 | A copy of the infernal contract your bloodline signed, in a hand that is not quite ink |
| 3 | A holy symbol you were handed at birth and have never decided how to feel about |
| 4 | A vial of water that is always faintly warm, or an ember that never quite goes out, or a stone that's heavier than it should be |
| 5 | A child's drawing of a "normal" version of you, made by someone who loved you anyway |
| 6 | A list of the names strangers have called you on sight, kept out of spite or study |
| 7 | A coin that runs hot, cold, or wet depending on a mood you can't predict |
| 8 | A small creature drawn to your heritage — a salamander, a will-o'-wisp, a too-clever fish (name it) |
| 9 | A letter from a celestial-touched sibling who got the destiny while you got the suspicion |
| 10 | A feather, a scale, or a pinch of ash from the thing in your bloodline, that will not burn, rot, or dry |
| 11 | A bargain-token a fiend, an angel, or an elemental left for you "to use when you're ready" |
| 12 | A wanted notice that lists your heritage as one of your crimes |
| 13 | A scrap of a language you have never been taught but understand when you're frightened |
| 14 | The veil, hood, or paint you wear when you need a port to forget what you are |
| 15 | A mirror that shows the mark even when you've hidden it, which you keep to stay honest |
| 16 | A relic of the Eye, the deep, or a far plane that hums in tune with your blood |
| 17 | A debt owed you by the one person who, on meeting you, didn't flinch |
| 18 | A small idol — to Besmara, who doesn't care what's in your veins, only what's in your hold |
| 19 | A keepsake of the parent who was *not* the planar one, and loved you the ordinary way |
| 20 | A sealed prophecy about you that you have never opened, and are not sure you believe in enough to burn |

# Make Your Pirate

*Make your pirate.*

A character in the Shackles is built from three pieces and a handful of details. The pieces answer three different questions, and none of them answers the other two:

- **Class** — *what can you do?* The toolkit that has kept you alive. (Part Six.)
- **Calling** — *why do you sail?* The obsession that keeps you from a quiet life ashore. (Part Five.)
- **Ancestry** — *who are you, and where are you from?* Purely who you are in the fiction; it grants no mechanics. (Step 4, below.)

Work through the steps in order. By the end you will have a character, a place at a crew, and a reason the sea will one day come to collect. Pencil, not pen — some of this is decided together with the table.

---

## Step 1 — Concept

One sentence. *A press-ganged Chelish navigator who found God in a storm and never went home. A dockside cardsharp building an empire of favours. A thing the jungle spat back out.* You do not need a backstory yet — the class, calling, and ancestry will hand you most of one. You need a hook you are excited to play.

## Step 2 — Choose a Class

Your class is your competence. Pick one of the ten (Part Six) and take everything in its **Core Traits**:

1. Its **core skill** and **core domain** — your starting skill and domain. (Everyone can attempt most things; a skill or domain adds a die and means you are genuinely good at it. See Part Three.)
2. Its **resource** — a single evocative item with a value and domain.
...
Your calling is your engine. Pick one of the seven personal callings (Part Five); if you are torn, the choosing guide settles it. Then:

1. Take its **core ability**.
...
Your ancestry is who you are before the dice hit the table. **It grants no mechanics** — no bonuses, no abilities, no protection. The storm does not care whether you are a half-orc or a Chelish noble; what matters is the grudges, loyalties, and reasons you are standing on a deck at the edge of the world.
...
You have five **resistance tracks** (Part Four): **Blood, Tide, Reputation, Luck, Gold**. They all start **empty** — a fresh character carries no stress.

**Protection** reduces stress before it is marked. You start with **0 protection** in every track unless a class ability or your equipment's `Block` tag says otherwise; protection is earned through advances, not bought as armour. Note any protection your starting abilities grant.
...
## Quick Reference — The Build

1. **Concept** — one sentence.
2. **Class** — core skill, core domain, resource, equipment (pick one), both core abilities.
3. **Calling** — core ability, answer four questions, roll a carry item.
4. **Ancestry** — lore, answer one question, name, roll two trinkets. *(No mechanics.)*
...
Roll a pool of **D10s, keep the single highest.** One die always, plus:

- **+1 die** for a relevant **skill**
- **+1 die** for a relevant **domain**
- **+1 die (mastery)** if a **knack** applies — max **4 dice**

| Highest die | Result |
|:--:|---|
| **10** | **Critical success** — what you wanted, plus extra. Step up your outgoing stress dice. |
| **8–9** | **Success** — what you wanted. No stress. |
| **6–7** | **Success at a cost** — you get it, but take stress or a complication. |
| **2–5** | **Failure** — take stress; it goes wrong. |
| **1** | **Critical failure** — take **double** stress. |

**Difficulty:** **Standard** (keep highest) · **Risky** (drop the highest die first) · **Dangerous** (drop the two highest). Good/excellent gear, a plan, position, or help can step it down. *Roll only when the outcome is uncertain* **and** *failure costs something.*

## Stress & Fallout

On a **2–7**, mark stress to a **track** (the GM picks the track from the **fiction**, not the skill). Dice by severity: **D4** minor · **D6** serious · **D8** dangerous · **D10** catastrophic. **Protection** reduces the rolled value first.

Then roll a **D12** vs. your **total** stress across all tracks:

| D12 vs. total | Outcome |
|---|---|
| **Higher** | No fallout — it accumulates. |
| **≤ total, D12 = 1–6** | **Minor fallout** — clear the marked track. |
| **≤ total, D12 = 7–12** | **Major fallout** — clear **all** tracks; something changes for good. |

## The Five Tracks

| Track | Is | Clears by |
|---|---|---|
| **Blood** | wounds, exhaustion, drowning, fire | rest, food, a surgeon |
| **Tide** | the supernatural getting in | ritual, arc-length story (hardest) |
| **Reputation** | your name and standing | public deeds, bonds, haunts |
| **Luck** | fated misfortune | **only when its fallout fires** |
| **Gold** | your material position | plunder, good trades |

*Equipment can never remove Tide, Luck, or Reputation.*

## The Four Gates

Recurring abilities use exactly one: **once per situation · per session · per journey · per campaign.** No rounds, no initiative — durations are scoped to the fiction.

## Equipment

Roll the dice on the gear; **no suitable gear = D4.** Ladder: **D4** improvised · **D6** civilian · **D8** professional · **D10** exotic · **D12** legendary. Quality (separate axis): **Standard / Good / Excellent / Renowned** (Renowned grants a knack). Weapons tagged **Brave / Hunt / Plunder**; journey gear **Navigate**; healing **Tend Blood/Gold/Hull**.

**Common tags:** **Brutal** (roll 2 stress dice, keep highest) · **Piercing** (ignores Blood protection) · **Ranged** · **Reload** · **Tiring** (dice drops on a fail) · **Block** (+1 Blood protection) · **Spread** (catches nearby targets) · **Wyrd** (max roll → mark Tide).

## Skills & Domains

**Skills (11):** Brave · Carouse · Command · Deceive · Endure · Hunt · Navigate · Plunder · Reckon · Tend · Vanish.
