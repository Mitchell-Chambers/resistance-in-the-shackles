...
When you compile a primer, you are pulling the ✅ parts of the master (see the System Reference contents table), trimming GM material, and pouring the result into the design language below. Compiled editions can be dropped in this folder alongside these two specs.
