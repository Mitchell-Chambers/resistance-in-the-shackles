...
### THE DUELLIST'S ART
_One opponent, agreed terms, and mathematics._ In single combat with a named opponent, your shots gain the Piercing tag. You were built for this.
- MINOR: PERFECT SHOT. Once per situation, after shots have been traded at least once, declare a shot perfect: roll with mastery and increase your stress dice by two steps.
- MINOR: READ THE DRAW. You always know when your duelling opponent is about to fire. Once per situation, you may interrupt their action with a shot of your own, rolling as normal, before their attack resolves.
- MINOR: SECOND GUN. In a duel, you always have a loaded weapon ready, as though you had prepared for this specific opponent. The opening moments cannot catch you without options.
...
**Version 4 rebuild.** Junk Mage chassis, kept: BURN THE BODY (Ravening Knowledge), SLOW MATCH (Sacrifice demoted to minor, mirroring V2), FALSE THUNDER (Litanies), SPARK IN THE CHAMBER (Kiss of the Drowned Queen), HIDDEN MAGAZINE (Sanctum of the Stone Chorus), all zeniths (Heralds). V4 cuts: THE DUELLIST'S ART loses its second passive (environmental-difficulty immunity) — one benefit per major base, like Backstab; POWDER TRADE converted to ask grammar; GHOL-GAN FIRE keeps the V3 one-formula trim. POWDER BOND, SHATTERING LOAD (−2), PERFECT SHOT (mastery + steps) and READ THE DRAW (once per situation) keep their V3 conversions. CALLED SHOT retained as-is: it rides on a successful roll, which is Heart-legal. Checklist unchanged: skills Reckon/Brave/Tend/Vanish + core Hunt; domains Faith/Ruins/Colonial/Outlaw + core Arcane (5/5, matching the Junk Mage); matrix Gold 2/Luck 2/no Reputation.

**Errata 2026-06-10:** exchange durations rewritten to fiction-scoped phrasing (Perfect Shot, Second Gun).
