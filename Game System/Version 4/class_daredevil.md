...
**Version 4 rebuild.** The doom-engine bypass class, now fully wired into the dice. Every escape either rolls or costs Luck: ALWAYS A WAY OUT keeps its V3 Luck price (it is the thesis and stays no-roll, but never free); THE VANISHING ACT converted from no-roll fiat to a rolled Vanish+Outlaw with a partial-success price — the roll replaces the V3 Luck cost; THE IMPOSSIBLE ROUTE keeps its V3 fail-forward roll; THE READ converted from a free question to a rolled Reckon+Outlaw (Echoes grammar — the Deadwalker's own info major rolls, so should this). MISDIRECTION, COASTWISE, SMOKE AND SHADOW, KNIFE ACT, RIGGING RAT and KNIFE STORM keep their V3 conversions. ACROBAT uses Mark of Shadow never-Risky grammar (Heart-legal). MOMENTUM and PICKPOCKET were already the set's models — untouched. ALL OR NOTHING (Reaper's Strike) and all zeniths are ports, untouched. Checklist unchanged: skills Brave/Hunt/Deceive/Reckon/Carouse + core Vanish; domains Shallows/Deepwater/Colonial + core Outlaw; matrix Blood 2/Luck 2/no Reputation. Forbidden: Endure, Tend.

**Errata 2026-06-10:** exchange durations rewritten to fiction-scoped phrasing (The Read, Leave a Double); Degenerating restored to SPECIALTY LOAD — the tag is canonical and now defined in the tag glossary.
