...
**Version 4 rebuild.** The two cores were the strongest in the set; both narrowed. THE FORM now requires a single opponent (the duel is the fantasy) and grants exactly one benefit — the dice step; the difficulty-immunity rider is gone. READ THE FIGHTER drops from three free facts per situation to two facts once per session, with the payoff routed through mastery. The big swap: **THE POINT THAT ENDS ARGUMENTS cut** — a once-per-session fight-ender has no Heart analogue at any tier. Replaced by **THE COMMITTED BLADE**, a direct port of the Heretic's OATH OF TENACITY with all three subs (Implacable Faith → Implacable Form, Glorious Resurgence → The Perfect Exchange, Abide With Me → The Offered Hilt) — voluntary risk-for-damage is the duellist engine Heart already wrote, and it feeds the doom engine instead of skipping it. The yield-not-kill fantasy survives in DUELLIST'S GAZE's reduce-to-0 clause. THE BORROWED PARRY converted from negation to D4 reduction (Miraculous Intervention grammar). CHALLENGE gated per session. COLONIAL PASSAGE, NAVAL LAW, REPUTATION OF THE BLADE keep V3 conversions. Untouched: DUELLIST'S GAZE (Staredown), ORDER'S BLADE (Dragon-Killer), PROTECTOR'S STANCE (Get Behind Me), zeniths. Checklist unchanged: skills Command/Deceive/Endure/Reckon/Brave + core Hunt; domains Outlaw/Port/Faith + core Colonial; matrix Blood 2/Gold 2/no Tide. Forbidden: Navigate, Plunder.

**Errata 2026-06-10:** exchange duration rewritten to fiction-scoped phrasing (Form Perfect). THE LAST BOUT's "the exchange is perfect in form" is prose, not a timing unit, and stands.
