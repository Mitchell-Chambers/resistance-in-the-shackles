...
**Version 4 rebuild.** The contrast class keeps its thesis (competence, no patron) but every certainty now has a shape Heart would print. THE SAME SAW gated to once per situation and trimmed to diagnose-only (the what-fails-next clairvoyance cut; Triage's three-answers folded out entirely — SECOND OPINION covers the sphere with a re-roll instead of free information). ENGINEERING MIND rebuilt around a direct port of the Junk Mage's RUST AND IRON (quality +1, Dangerous + Unreliable, once per item) with the build-the-impossible clause kept as GM-priced fiction. CARPENTER'S EYE and SABOTEUR roll with mastery; SALVAGE INSTINCT converted to ask grammar; SHIPS' GRAVEYARDS trimmed to one perk; NO DEAD SHIPS now rolls; AMPUTATION matches On Your Feet grade (downgrade/remove fallout, stress stays). NOT TODAY keeps its V3 once-per-campaign gate and codified bill. Kept untouched: CANNIBALISED PARTS (Vermissian Plate port), THE MILESTONE, all zeniths. Checklist unchanged: skills Brave/Plunder/Reckon/Endure + core Tend; domains Wilderness/Port/Shallows/Colonial + core Deepwater (5/5); matrix Reputation 2/Gold 2/no Tide. Forbidden: Hunt, Vanish.

**Errata 2026-06-10:** The Living Ship reworded to Hull-track grammar (+1 Hull protection; mechanically identical).
