...
### CRAB AND ROOT
_You learned medicine from an island pharmacopoeia that no physician has catalogued._ Gain the Tend skill. You can treat Blood stress and fallout without equipment or supplies, using whatever grows, crawls or seeps nearby.
