...
> **Location Tiers (working draft — to graduate into its own system document):**
> - **Tier 0** — Civilised, lawful places: colonial harbours, naval stations, merchant towns.
> - **Tier 1** — Pirate ports, settled coasts, busy shipping lanes.
> - **Tier 2** — Open sea, charted islands, the coastal wilds.
> - **Tier 3** — Deep island interiors, uncharted waters, Ghol-Gan ruins.
> - **Tier 4** — The Eye of Abendego, the drowned trenches, places with no name.
...
### CRAB AND ROOT
_You learned medicine from an island pharmacopoeia that no physician has catalogued._ Gain the Tend skill. You can treat Blood stress and fallout without equipment or supplies, using whatever grows, crawls or seeps nearby. Your remedies work in ways trained surgeons find difficult to account for.
...
### RUIN-WALKER
_The old stonework feels inhabited to you, and whatever inhabits it has decided you can stay._ Gain the Ruins domain. Once per situation, when a passive ruin hazard — a collapse, a flood, a trap left by dead hands, the spatial wrongness of inhuman architecture — would catch you, you get warning enough to act first.

### SALT-STILL
_Things that hunt by motion taught you the value of perfect quiet._ Gain the Vanish skill. While you remain still in natural terrain — jungle, reef, shoreline, ruin — Vanish rolls are never considered Risky or Dangerous, and nothing that hunts by scent can find you.

### SCAVENGED ARSENAL
_Your hands know what to make before your mind has finished the question._ Gain the Plunder skill. Given ten minutes and available materials, you can construct a functional weapon, trap or tool; doing so under pressure requires a roll. Improvised weapons you create deal D6 stress rather than D4. The results are ugly. They are exactly sufficient.

### SPEAKING TO STRAYS
_Whatever the island put in you, the animals can smell it too._ Gain the Arcane domain. Creatures of the wild Shackles treat you as adjacent kin — neither prey nor pack, simply present. They do not attack you without provocation, and you can direct them with gesture and intent. Once per session, you can call on the local wildlife to create a distraction, carry a small object or throw an area into bestial chaos.
...
**Source:** Direct reskin of the Cleaver (Heart core). Mapping: Hunt/Cursed → Endure/Wilderness; Echo → Tide; Fortune → Luck; Supplies → Gold; Heartsblood → Islandsblood; delve → journey; Haven tag → tier 0–1 locations.

**Checklist compliance:**
- Minors: 3 generic + 10 named (5 skill+text: Tend, Hunt, Vanish, Plunder, Brave; 3 domain+text: Deepwater, Ruins, Arcane; 2 bare +2 protection).
- Protection matrix: **Blood 2, Tide 2, no Luck** — Luck excluded from INHUMAN and granted nowhere.
- Named skills incl. core: 6. Named domains incl. core: 4. **Forbidden skills: Carouse, Command** (the solitary survivor — excluded from all lists).
- Majors: 5 — companion, core-adjacent transformation, weapon grant, core upgrade, support. Every active major rolls vs Endure+Wilderness or is conditional, matching Cleaver.
- Zeniths: 3 (violent/transcendent, triumphant/territorial, sacrificial/rebirth).

**Deviations & open questions:**
1. **No spatial/travel major** — the guide flags one as near-mandatory, but the Cleaver itself has none and I kept the suite faithful. If you want one, the Pass 1 major *The Island Remembers You* (sanctuary island + hidden anchorage) is the natural swap for WHAT CAME BACK or a sixth major.
2. **Wyrd tag** (WHAT CAME BACK) — kept Heart's tag name for now; if the Shackles renames it (e.g. *Fathomless* or *Tide-touched*), update here.
3. **Location tiers** — drafted a 0–4 wildness scale inline for Islandsblood; should graduate into its own system document since ship combat, journeys and other classes will want it.
4. Pass 1's marks system (*What the Island Left*) and the not-voice were cut for parity with Cleaver's tighter budget; the flavour survives in ability text. The not-voice could return as calling material.

**Version 3 changes (conversion pass per heart_pattern_analysis.md):** FERAL TRACKING and SCAVENGED ARSENAL route through rolls; SALT-STILL converted to Mark of Shadow grammar (Vanish never Risky while still); RUIN-WALKER trimmed to a once-per-situation hazard warning, always-know-position cut.
