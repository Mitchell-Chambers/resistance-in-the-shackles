...
**Version 4 rebuild — the heaviest in the set.** The information empire was the imbalance: six free info-taps and two fiat majors. Fixed at the root:

- **Cores:** THE WEB demoted out of the core slot. New core THE SURE THING is a verbatim port of the Incarnadine's COST OF DOING BUSINESS (Fortune→Luck) — a banked-die gambling engine that is mechanically rich, fully priced, and the single most Sharper-shaped ability in all of Heart. DOUBLE OR NOTHING (Crucible port) unchanged. Both cores now ride the Luck track from opposite directions.
- **Cut entirely:** THE PERFECT LIE and THE KILLING WORD (standing GM contracts; their fantasies survive in FALSE FACE, NEVER WAS, EVERYBODY OWES and THE HOOK), COLD READ (→ THE TELL, a port of the Witch's OLD BLOOD: surface emotions, not three facts), DEAD DROP NETWORK (→ NOSE FOR GOLD, a verbatim port of the Incarnadine's LOST IT ALL), LEVERAGE (→ MARKED CARDS, Righteous Rhetoric grammar: mastery, not compulsion).
- **New majors:** THE CHEAP SHOT is a full port of the Incarnadine's BACKSTAB with all three subs (Mind→Luck, Supplies→Gold) — the Sharper finally has a combat sphere, fixing the all-social similarity problem. THE WEB rebuilt as a major: rolled to establish, three contacts, every use priced in Gold/Reputation/debt.
- **Kept:** THE HOOK (Crave), EVERYBODY OWES (Karmic Ledger), THE BACK ROOM (Lair, omniscience cut), all zeniths.

Checklist unchanged: skills Plunder/Carouse/Vanish/Command/Reckon + core Deceive; domains Colonial/Outlaw/Arcane + core Port; matrix Reputation 2/Luck 2/no Blood. Forbidden: Brave, Endure.

**Errata 2026-06-10 (second pass):** THE BACK ROOM's bond clause restored — the Witch's LAIR explicitly "acts as a bond" in Heart, and the V4 port wrongly dropped it because bonds didn't exist in our system yet. Web contacts were *not* auto-bonded: Heart forms bonds only at GM discretion and never converts an NPC network into bonds wholesale.

**Version 5 rebalance.** Combat raised to the protected floor and the Social spike trimmed (+6→~+3): UNCANNY TRADE → THE SLEEVE (Hunt; concealed-weapon Brutal first strike); MARKED CARDS → THE LONG CON'S END (social setup feeds the kill — mastery + 1 step). Arcane-fence flavour folds into THE WEB. Footprint shifts to **7 skills** (gained Hunt) / **3 domains** (Arcane now via the OLD HAUNTS pick). Combo: THE LONG CON'S END and THE CHEAP SHOT do not stack on one strike.
