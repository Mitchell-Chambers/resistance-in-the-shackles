...
**Version 5 rebalance.** THE DUELLIST'S ART major cut to bring the class to the 23-ability baseline (5 majors). The gunfighter identity is amply carried by ARCANE LOAD, POWDER KEG, SPARK IN THE CHAMBER and the cores; combat eases from +6 toward +5 — still the signed-off, on-theme spike. Nothing folded in (the cut was the point).
